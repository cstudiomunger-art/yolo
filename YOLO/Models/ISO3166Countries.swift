...
enum ISO3166 {
    ...
    static func flag(_ code: String) -> String {
        let base: UInt32 = 127397   // 0x1F1E6 - UnicodeScalar("A")
        var s = String.UnicodeScalarView()
        for u in code.uppercased().unicodeScalars where (65...90).contains(u.value) {
            if let scalar = Unicode.Scalar(base + u.value) { s.append(scalar) }
        }
        let out = String(s)
        return out.isEmpty ? "🏳️" : out
    }
    ...
    private static let raw: [(String, String)] = [
        ...
        ("CA", "加拿大"), ("KY", "开曼群岛"), ("CF", "中非"), ("TD", "乍得"),
        ("CL", "智利"), ("CN", "中国"), ("CX", "圣诞岛"), ("CC", "科科斯（基林）群岛"),
        ("CO", "哥伦比亚"), ("KM", "科摩罗"), ("CG", "刚果共和国"), ("CD", "刚果民主共和国"),
        ...
        ("FR", "法国"), ("GF", "法属圭亚那"), ("PF", "法属波利尼西亚"), ("TF", "法属南部和南极领地"),
