...
INSERT INTO attractions (
  ...
  '[{"icon": "🎫", "label": "Ticket", "value": "40 / 15 RMB"}, {"icon": "🕘", "label": "Opening Hours", "value": "7:00–17:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1, Longxiangqiao or Fengqi Road station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No.1 Longjing Road, Xihu District, Hangzhou, Zhejiang Province (West Lake Scenic Area)',
  '浙江省杭州市西湖区龙井路1号（西湖风景名胜区）',
  0,
  'com.chinago.travel.attraction.hangzhou_west_lake',
  0,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('hangzhou_lingyin_temple',
  'hangzhou',
  'Lingyin Temple (Temple of Soul''s Retreat)',
  '灵隐寺',
  'temple',
  'attractions/hangzhou_lingyin_temple.png',
  'Lingyin Temple, Hangzhou''s oldest Buddhist monastery founded in 326 AD (Eastern Jin Dynasty), has approximately 1,700 years of history. One of China''s Ten Great Chan Buddhist Temples, it is world-famous for the Feilai Peak grotto sculptures and its profound Zen atmosphere.',
  'Lingyin Temple, at No.1 Fayun Lane, Lingyin Road, Xihu District, sits in the Lingyin foothills flanked by Feilai Peak and Beigao Peak. One of China''s Ten Great Chan Buddhist Temples, it was founded in 326 AD by the Indian monk Huili. Legend holds that upon reaching Feilai Peak, Huili exclaimed, ''This is a small peak from Vulture Peak in Central India — how did it fly here?'' Hence the name ''Feilai Peak'' (Peak that Flew Here), and the temple was named ''Lingyin'' — ''the retreat of the soul.'' The temple reached its zenith during the Wuyue Kingdom with nine towers, eighteen pavilions, and over 3,000 monks. Most existing structures date from the Qing Dynasty, arrayed along the central axis. Feilai Peak preserves 345 Buddhist grotto carvings from the 10th-14th centuries, with Yuan Dynasty Tibetan Buddhist-style carvings being especially precious. The temple is intimately associated with the legendary monk Jigong, who took vows here. Ancient camphor trees over a thousand years old stand among yellow-walled halls. Note: visitors typically purchase a Feilai Peak scenic area ticket (45 RMB) first, then a separate Lingyin Temple incense ticket (30 RMB).',
  'P0',
  'Feilai Peak Scenic Area: 45 RMB; Lingyin Temple Incense Ticket: 30 RMB. Total: 75 RMB. Half-price for seniors, children, and students. Hangzhou Temple Annual Pass waives the incense fee.',
  NULL,
  'Daily 7:30-18:00 (last entry 17:00). Hours may adjust during special Dharma assemblies.',
  NULL,
  FALSE,
  'Bus Routes 7, 278, 324M, 505 to Lingyin Station. Metro Line 3 to Dongyue Station, then transfer to bus or 10-min taxi. Lingyin Road can be heavily congested during holidays; metro + bus recommended. Scenic shuttle from Faxi Temple to Lingyin Temple (10 RMB).',
  '[{"icon": "🎫", "label": "Ticket", "value": "75 RMB"}, {"icon": "🕘", "label": "Opening Hours", "value": "7:30–18:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 3, Dongyue Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No.1 Fayun Lane, Lingyin Road, Xihu District, Hangzhou, Zhejiang Province',
  '浙江省杭州市西湖区灵隐路法云弄1号',
  0,
  'com.chinago.travel.attraction.hangzhou_lingyin_temple',
  1,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('hangzhou_leifeng_pagoda',
  'hangzhou',
  'Leifeng Pagoda (Leifeng Tower)',
  '雷峰塔',
  'temple',
  'attractions/hangzhou_leifeng_pagoda.png',
  'Leifeng Pagoda, site of West Lake''s iconic ''Leifeng Pagoda in Evening Glow,'' was first built in 977 AD. World-famous for the Legend of the White Snake, it was rebuilt in 2002, offering 360-degree panoramic views of West Lake.',
  'Leifeng Pagoda, at No.15 Nanshan Road in the West Lake Scenic Area, stands on Sunset Hill on West Lake''s southern shore. Originally named Huangfei Pagoda, it was built in 977 AD by Qian Chu, the last king of the Wuyue Kingdom, to enshrine the Buddha''s hair relic. The original seven-story octagonal brick-and-wood pagoda was burned by Japanese pirates during the Ming Jiajing reign, leaving only the brick core. On September 25, 1924, the millennium-old pagoda finally collapsed. The new pagoda, rebuilt in 2002, uses an innovative steel-frame, bronze-clad structure that restores Southern Song architectural form while showcasing bronze culture through modern techniques. Standing 71.679 meters with five above-ground and two underground floors, it displays national treasures including the gilt-silver Ashoka Stupa. Immortalized by the Legend of the White Snake — the story of Bai Suzhen imprisoned beneath the pagoda by Monk Fahai — it carries a romantic yet tragic cultural aura. From the top, a 360-degree panorama unfolds: Baochu Pagoda north, lakeside east, Jingci Temple south, and Su Causeway west. At dusk, ''Leifeng Pagoda in Evening Glow'' is breathtaking.',
  'P0',
  'Adult: 40 RMB. Combo tickets: Pagoda + Yue Fei Temple 60 RMB; Pagoda + Lake Cruise 75 RMB. Half-price for seniors, children, and students.',
  NULL,
  'Nov 1-Mar 15: 8:00-17:30; Mar 16-Apr 30: 8:00-19:00; May 1-Oct 31: 8:00-20:00. Ticket sales stop 30 minutes before closing.',
  NULL,
  FALSE,
  'Bus Routes 4, 12, 31, 51, 52, 315 to Jingci Temple or Leifeng Pagoda Station. West Lake sightseeing bus also stops here. Metro Line 7 to Wushan Square Station, then transfer to bus or walk about 20 min.',
  '[{"icon": "🎫", "label": "Ticket", "value": "40 RMB"}, {"icon": "🕘", "label": "Opening Hours", "value": "8:00–17:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 7, Wushan Square Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No.15 Nanshan Road, Xihu District, Hangzhou, Zhejiang Province',
  '浙江省杭州市西湖区南山路15号',
  0,
  'com.chinago.travel.attraction.hangzhou_leifeng_pagoda',
  2,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('hangzhou_xixi_wetland',
  'hangzhou',
  'Xixi National Wetland Park',
  '西溪国家湿地公园',
  'park',
  'attractions/hangzhou_xixi_wetland.png',
  'Xixi Wetland is China''s first national wetland park, located in western Hangzhou less than 5 km from West Lake. A rare urban secondary wetland, it is renowned for its poetic charm and pristine waterscape, designated a national 5A tourist attraction.',
  'Xixi National Wetland Park, at No.518 Tianmushan Road, Xihu District, western Hangzhou, less than 5 km from West Lake and 6 km from Wulinmen, covers ~11.5 km². It is China''s first wetland park integrating urban, agricultural, and cultural wetlands — the only site simultaneously holding national wetland park, national 5A attraction, and internationally important wetland status. Approximately 70% of the park comprises waterways, ponds, lakes, and marshes, with six main rivers crisscrossing to form a unique misty waterscape. The park is divided into East Area and West Area (Hong Garden). East Area highlights include Green Causeway (Flower Festival venue, spectacular spring blooms), Fu Causeway (main north-south trail), Shou Causeway, and an underwater ecological corridor. West Area''s Hong Garden features Hong family culture and traditional opera, with historic buildings including Hong Mansion and ancestral hall. A bird paradise, 186 species have been recorded, including endangered Oriental White Storks and Black-faced Spoonbills. Visitors can explore by electric boat or hand-rowed boat, drifting through reed marshes in poetic serenity. Xixi gained fame as a filming location for ''If You Are the One.'' Traditional dragon boat races are held here during the annual Dragon Boat Festival.',
  'P1',
  'Adult: 80 RMB. Seniors/children/students: half-price 40 RMB. Electric boat: 60 RMB/person. Hand-rowed boat: ~100 RMB/hour. Some areas (e.g., Green Causeway) offer free admission during special periods like the Flower Festival.',
  NULL,
  'Summer (Apr 1-Oct 31): 7:30-18:30 (tickets until 17:30, last entry 18:00); Winter (Nov 1-Mar 31): 8:00-17:30 (tickets until 16:30, last entry 17:00).',
  NULL,
  FALSE,
  'Metro Line 3 to Xixi Wetland South or Huawu Station; Line 19 to Xixi Wetland North Station. Bus Routes 83, 86, 149, 193, 310 to Xixi Wetland Zhoujiacun. By car: navigate to ''Zhoujiacun Entrance Parking.''',
  '[{"icon": "🎫", "label": "Ticket", "value": "80 / 100 RMB"}, {"icon": "🕘", "label": "Opening Hours", "value": "7:30–18:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 3, Xixi Wetland South or Huawu Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No.518 Tianmushan Road, Xihu District, Hangzhou, Zhejiang Province (Zhoujiacun Entrance)',
  '浙江省杭州市西湖区天目山路518号（周家村入口）',
  0,
  'com.chinago.travel.attraction.hangzhou_xixi_wetland',
  3,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('hangzhou_qiandao_lake',
  'hangzhou',
  'Qiandao Lake (Thousand Island Lake)',
  '千岛湖景区',
  'park',
  'attractions/hangzhou_qiandao_lake.png',
  'Qiandao Lake is an artificial lake formed in 1959 by the Xin''an River hydropower station, featuring 1,078 islands scattered across crystal-clear emerald waters. A national 5A tourist attraction, it is the most popular eco-resort destination in the Yangtze River Delta region.',
  'Qiandao Lake Scenic Area, in Chun''an County, Hangzhou, is located in the Yangtze River Delta hinterland, about 150 km from Hangzhou and 140 km from Huangshan. Formed in 1959 when the Xin''an River Dam was completed, the dendritic lake covers 573 km² with an average depth of 34 meters (maximum over 100 meters). Its 1,078 islands give it the name ''Thousand Island Lake.'' The lake is famous for its unique landscape — water quality consistently meets national Grade I standards with visibility of 7-12 meters, earning the title ''Number One Beautiful Water Under Heaven.'' The Central and Southeast lake districts are the main tourist areas. Central District features Meifeng Island (panoramic views), Moonlight Island (romance-themed island group), Dragon Mountain Island (home to Hai Rui Shrine), and Yule Island. Southeast District boasts Huangshan Peak (famous for its ''Tian Xia Wei Gong'' four-character island formation), Tianchi Island, and Osmanthus Island. Remarkably, two ancient cities — Shi Cheng and He Cheng — lie submerged beneath the lake, nicknamed ''Underwater Pyramids.'' A 150 km lakeside greenway encircles the lake, perfect for cycling. The lake is renowned for its organic fish head soup, a must-try local delicacy. Best visiting season: March to November.',
  'P0',
  'Central District: Adult 130 RMB + boat 65 RMB (total 195 RMB); Southeast District: same pricing. Half-price admission for seniors, children, and students. Advance online reservation and ticket purchase required.',
  NULL,
  'Lake area: 8:00-16:00 (boat departures mainly in the morning; arrive at pier by 8:00-10:00 recommended). Individual island hours may vary.',
  NULL,
  TRUE,
  'High-speed rail: Hangzhou East/West Station to Qiandao Lake Station, ~1 hour, ~70 RMB. Shuttle Bus 1 from station to lake pier (15 RMB, ~45 min). By car: ~2 hours via Hangzhou-Qiandao Expressway. Long-distance bus: Hangzhou West Bus Station to Qiandao Lake, ~2.5 hours.',
  '[{"icon": "🎫", "label": "Ticket", "value": "195 RMB"}, {"icon": "🕘", "label": "Opening Hours", "value": "8:00–16:00"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'Qiandaohu Town, Chun''an County, Hangzhou, Zhejiang Province (Central District Pier: No.348 Menggu Road)',
  '浙江省杭州市淳安县千岛湖镇（中心湖区旅游码头：梦姑路348号）',
  0,
  'com.chinago.travel.attraction.hangzhou_qiandao_lake',
  4,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('hangzhou_zhejiang_museum',
  'hangzhou',
  'Zhejiang Provincial Museum',
  '浙江省博物馆',
  'museum',
  'attractions/hangzhou_zhejiang_museum.png',
  'The Zhejiang Provincial Museum is Zhejiang''s largest comprehensive humanities museum, with two main venues — Zhijiang and Gushan. Housing over 100,000 artifacts, it is renowned for its Liangzhu jades, Yue kiln celadon, and the masterpiece painting ''Dwelling in the Fuchun Mountains.''',
  ...
  'P1',
  'FREE. Advance reservation required via the museum''s WeChat account (up to 7 days ahead). Special temporary exhibitions may charge separately.',
  NULL,
  'Zhijiang Venue: Tue-Sun 9:00-17:00 (last entry 16:30), closed Mon (except holidays). Gushan Venue: Tue-Sun 9:00-17:00 (last entry 16:30), closed Mon (except holidays).',
  NULL,
  TRUE,
  'Zhijiang: Metro Line 6 to Zhijiang Cultural Center or Fenghua West Road (~10 min walk). Bus Routes 149, 324M to Zhijiang Cultural Center. Gushan: Bus Routes WE1314 and West Lake Outer Circle to Zhejiang Provincial Museum Station. Underground parking available at both venues.',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "9:00–17:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 6, Zhejiang Provincial Museum Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'Zhijiang Venue: Bibo Road, Zhijiang Cultural Center, Xihu District; Gushan Venue: No.25 Gushan Road, Xihu District, Hangzhou, Zhejiang',
  '之江馆区：杭州市西湖区碧波路之江文化中心；孤山馆区：杭州市西湖区孤山路25号',
  0,
  'com.chinago.travel.attraction.hangzhou_zhejiang_museum',
  5,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('hangzhou_grand_canal',
  'hangzhou',
  'Beijing-Hangzhou Grand Canal (Hangzhou Section)',
  '京杭大运河（杭州段）',
  'sight',
  'attractions/hangzhou_grand_canal.png',
  'The Hangzhou section of the Beijing-Hangzhou Grand Canal is the southern highlight of the world''s longest man-made waterway, stretching about 7.3 km with Gongchen Bridge at its heart, linking three historical blocks and numerous museums — inscribed as a UNESCO World Heritage Site in 2014.',
  ...
  'P1',
  'Canal-side blocks are free. Water bus: 3 RMB/person. Night cruise: approx. 100-150 RMB/person. All museums free.',
  NULL,
  'Canal banks: 24/7. Water bus: approx. 7:00-18:00 (varies by route). Museums: Tue-Sun 9:00-16:30.',
  NULL,
  FALSE,
  '- **Metro:** Lines 1/3/19 to West Lake Cultural Square Station; Line 3 to Xiangji Temple Station.
...
- **By Car:** Navigate to "Wulinmen Pier" or "Canal World." Paid parking available.',
  '[{"icon": "🎫", "label": "Ticket", "value": "3 / 150 RMB"}, {"icon": "🕘", "label": "Opening Hours", "value": "7:00–18:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 3, Xiangji Temple Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No.226 Huancheng North Road, Gongshu District, Hangzhou, Zhejiang (Wulinmen Pier)',
  '浙江省杭州市拱墅区环城北路226号（武林门码头）',
  0,
  'com.chinago.travel.attraction.hangzhou_grand_canal',
  6,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
- **By Car:** Navigate to "Gongchen Bridge" or "Canal Cultural Square." Paid parking available nearby.',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "9:00–16:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 5, \"Grand Canal Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No.1 Qiaonong Street, Gongshu District, Hangzhou, Zhejiang Province (connected to Canal Cultural Square on the east and Qiaonong Street on the west)',
  '浙江省杭州市拱墅区桥弄街1号（东连运河文化广场，西接桥弄街）',
  0,
  'com.chinago.travel.attraction.hangzhou_gongchen_bridge',
  7,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
- **Walking:** A pleasant 2 km walk from Lingyin Temple along Tianzhu Road, passing Zhongtianzhu and Xiatianzhu temples, takes about 30 minutes through bamboo groves and streams.',
  '[{"icon": "🎫", "label": "Ticket", "value": "10 RMB"}, {"icon": "🕘", "label": "Opening Hours", "value": "6:30–18:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 3, \"Dongyue Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No.338 Tianzhu Road, Xihu District, Hangzhou, Zhejiang Province',
  '浙江省杭州市西湖区天竺路338号',
  0,
  'com.chinago.travel.attraction.hangzhou_faxi_temple',
  9,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('hangzhou_liangzhu_ancient_city',
  'hangzhou',
  'Archaeological Ruins of Liangzhu City',
  '良渚古城遗址公园',
  'museum',
  'attractions/hangzhou_liangzhu_ancient_city.png',
  'The Archaeological Ruins of Liangzhu City is the sacred site that substantiates China''s 5,000-year civilization, dating back 5,300-4,300 years. Known as ''China''s First City,'' it was inscribed as a UNESCO World Heritage Site in 2019.',
  'Liangzhu Ancient City Archaeological Site Park, on Fengdu Road, Pingyao Town, Yuhang District, is the core site of Liangzhu Culture dating back 5,300-4,300 years, spanning approximately 1,000 years of the late Neolithic period. Archaeological discoveries began in 1936, and over eighty years of excavation have revealed more than 300 sites including high-ranking cemeteries, altars, jade ritual systems, large palace foundations, and ancient city walls. Archaeologists have hailed it as ''China''s First City.'' On July 6, 2019, Liangzhu Ancient City was inscribed as a UNESCO World Heritage Site. The park covers 42 km² across three areas. Key exhibition zones include: Mojiao Hill Palace Area (the city core, ~300,000 m²); Fanshan Royal Cemetery (where the ''King of Jade Cong'' was unearthed); ancient city wall remains; and China''s earliest known large-scale water conservancy system. Liangzhu Culture is world-renowned for exquisite jade craftsmanship. The park features beautiful seasonal landscapes and free-roaming sika deer. On June 15, 2023, the 19th Asian Games flame was kindled at Great Mojiao Hill.',
  'P1',
  'Adult: 60 RMB (Hangzhou residents ~30 RMB with ID). Children/seniors/students: 30 RMB. Free during Hangzhou Liangzhu Day (Jul 5-13). Advance reservation via official WeChat account required.',
  NULL,
  'Daily 9:00-17:00 (last entry 16:00). Open year-round; check announcements for special closures.',
  NULL,
  TRUE,
  'Metro Line 2 to Liangzhu Station Exit D, transfer to Bus 430M or 1222M to Liangzhu Ancient City Park Station. By car: navigate to South Entrance (parking available). Express Bus 348 from Hangzhou East Railway Station.',
  '[{"icon": "🎫", "label": "Ticket", "value": "60 / 30 RMB"}, {"icon": "🕘", "label": "Opening Hours", "value": "9:00–17:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 2, Liangzhu Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'Fengdu Road, Pingyao Town, Yuhang District, Hangzhou, Zhejiang (South Entrance of Liangzhu Ancient City Park)',
  '浙江省杭州市余杭区瓶窑镇凤都路（良渚古城遗址公园南入口）',
  0,
  'com.chinago.travel.attraction.hangzhou_liangzhu_ancient_city',
  10,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
- **By Car:** Navigate to "Wushan Square Parking" or "Gaoyin Street Parking" (approx. 10 RMB/hour).',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "9:00–22:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1, Ding''an Road Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'Hefang Street, Shangcheng District, Hangzhou, Zhejiang Province (from Zhonghe Road east to Wushan Square west)',
  '浙江省杭州市上城区河坊街（东起中河路，西至吴山广场）',
  0,
  'com.chinago.travel.attraction.hangzhou_hefang_street',
  11,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('hangzhou_silk_museum',
  'hangzhou',
  'China National Silk Museum',
  '中国丝绸博物馆',
  'museum',
  'attractions/hangzhou_silk_museum.png',
  'The China National Silk Museum, located by West Lake at the foot of Yuhuang Hill, is China''s largest textile and costume-themed national first-class museum and the world''s largest silk museum, offering free admission to the public.',
  ...
  'P2',
  'Free admission. Individual visitors do not need reservations. Group visits require advance reservation via the official website or WeChat account.',
  NULL,
  'Tuesday-Sunday 9:00-17:00 (last entry 16:30). Closed Mondays (except public holidays).',
  NULL,
  TRUE,
  'Bus Routes 12, 31, 42, 87, 133 to Silk Museum Station. Metro Line 7 to Wushan Square Station, then transfer to bus (~15 min). By car: navigate to ''China National Silk Museum'' (parking available on-site).',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "9:00–17:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 7, Wushan Square Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No.73-1 Yuhuangshan Road, Xihu District, Hangzhou, Zhejiang Province',
  '浙江省杭州市西湖区玉皇山路73-1号',
  0,
  'com.chinago.travel.attraction.hangzhou_silk_museum',
  13,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('hangzhou_west_lake_cultural_plaza',
  'hangzhou',
  'West Lake Cultural Square',
  '西湖文化广场',
  'museum',
  NULL,
  'West Lake Cultural Square, located north of the Grand Canal at Wulin Square in downtown Hangzhou, is a comprehensive urban landmark integrating culture, entertainment, exhibitions, and performances. Its 170-meter Global Center tower is one of Hangzhou''s iconic buildings.',
  ...
  'P2',
  'The square is FREE. Museums (Zhejiang Museum of Natural History, Science Museum) require advance reservation via their WeChat accounts (free). Cultural performances require separate tickets.',
  NULL,
  'Square: 24/7. Museums: generally Tue-Sun 9:00-16:30 (closed Mon). Musical fountain: nightly 19:30-20:30.',
  NULL,
  TRUE,
  'Metro Lines 1/3/19 to West Lake Cultural Square Station Exit C/D. Bus Routes 3, 6, 26, 33, 78 to West Lake Cultural Square. By car: navigate to underground parking. Water Bus Line 1 to West Lake Cultural Square Pier.',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "9:00–16:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No.47 Huancheng North Road, Gongshu District, Hangzhou, Zhejiang Province',
  '浙江省杭州市拱墅区环城北路47号',
  0,
  'com.chinago.travel.attraction.hangzhou_west_lake_cultural_plaza',
  14,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
