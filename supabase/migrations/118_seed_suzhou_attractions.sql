...
) VALUES ('suzhou_humble_administrators_garden',
  'suzhou',
  'Humble Administrator''s Garden',
  '拙政园',
  'garden',
  'attractions/suzhou_humble_administrators_garden.png',
  'The foremost of China''s four greatest classical gardens and the icon of Suzhou gardens, celebrated for its water-centered landscape and title as the “Mother of All Gardens.”',
  'Located at No. 178 Northeast Street, Gusu District, Suzhou, the Humble Administrator''s Garden was founded in the early Zhengde reign of the Ming Dynasty by censor Wang Xianchen after his retirement. Its name comes from Pan Yue''s “Fu on Living in Retirement” in the Jin Dynasty: “Irrigating the garden and selling vegetables to supply daily meals... this is the governance of the unambitious.” It is the foremost of China''s four greatest classical gardens and the largest surviving classical garden in Suzhou, inscribed on the UNESCO World Heritage List in 1997.
...
The garden embodies the essence of Jiangnan garden design, employing borrowed scenery, opposite scenery, framed views, and concealed views with masterful skill. Spring brings azaleas, summer lotus, autumn chrysanthemums, and winter plum blossoms. Its couplets and plaques are the work of famous scholars, adding rich cultural depth. As the outstanding representative of Suzhou gardens, the Humble Administrator''s Garden is both the top destination for visitors to Suzhou and an essential model for studying Chinese classical garden art.',
  'P0',
  '- Adult ticket: CNY 80 in peak season, CNY 70 in off-season
...
- Note: Real-name time-slot reservations are required. Advance booking through official channels is strongly recommended',
  NULL,
  '- Peak season (March 1 – November 15): 07:30–17:30 (ticket sales and entry stop at 17:00)
- Off-season (November 16 – February 28): 07:30–17:00 (ticket sales and entry stop at 16:30)',
  NULL,
  TRUE,
  '- Metro: Take Metro Line 4 to Beisi Pagoda Station and walk 10–15 minutes; or take Line 6 to Humble Administrator''s Garden Station and walk 5–8 minutes
...
- Taxi/ride-hailing: Set destination to “No. 178 Northeast Street, Humble Administrator''s Garden”',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "07:30–17:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 4, Beisi Pagoda Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 178 Northeast Street, Gusu District, Suzhou, Jiangsu Province, China',
  '江苏省苏州市姑苏区东北街178号',
  0,
  'com.chinago.travel.attraction.suzhou_humble_administrators_garden',
  0,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('suzhou_lingering_garden',
  'suzhou',
  'Lingering Garden Scenic Area',
  '留园景区',
  'garden',
  'attractions/suzhou_lingering_garden.png',
  'One of China''s four greatest classical gardens, celebrated for its exquisite architecture, ingenious spatial design, and the famous “Cloud-Capped Peak” rock.',
  'Located at No. 338 Liuyuan Road, Gusu District, Suzhou, Lingering Garden was first built during the Wanli reign of the Ming Dynasty. Originally called Dongyuan, it was later acquired by Liu Shu in the Qing Dynasty, renamed Hanbi Mountain Villa, popularly known as Liuyuan, and finally officially named Lingering Garden. As one of China''s four greatest classical gardens, it was inscribed on the UNESCO World Heritage List in 1997.
...
The garden''s most celebrated feature is the Cloud-Capped Peak, a 6.5-meter Taihu stone masterpiece, accompanied by the Auspicious Peak and the Misty Peak. With its high density of buildings, rich spatial layers, and diverse landscaping techniques, Lingering Garden represents the peak of Jiangnan garden art, offering visitors an ever-changing visual experience at every turn.',
  'P0',
  '- Adult ticket: CNY 55 in peak season, CNY 45 in off-season
- Discount ticket: CNY 27.5 in peak season, CNY 22.5 in off-season (students, seniors aged 60-69 with valid ID)
- Free admission: children under 6 or under 1.4m, seniors aged 70+, active servicemen, and people with disabilities (valid ID required)
- Peak season: April, May, July, August, September, October; off-season: January, February, March, June, November, December
- Note: Advance booking via official channels is recommended. Prices are subject to on-site announcement',
  NULL,
...
- Off-season (January–March, June, November, December): 07:30–17:00 (ticket sales and entry stop at 16:30)',
  NULL,
  FALSE,
  '- Metro: Take Metro Line 2 to Shilu Station and walk 10–15 minutes; or take Line 1 to Guangjinan Road Station and transfer to bus or walk about 20 minutes
...
- Taxi/ride-hailing: Set destination to “No. 338 Liuyuan Road, Lingering Garden Scenic Area”',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "07:30–17:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 2, Shilu Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 338 Liuyuan Road, Gusu District, Suzhou, Jiangsu Province, China',
  '江苏省苏州市姑苏区留园路338号',
  0,
  'com.chinago.travel.attraction.suzhou_lingering_garden',
  1,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
The garden is divided into ancestral hall, residence, and garden sections. Yanyu Hall is the main hall, bright and spacious; Zhibai Pavilion faces the water with ancient cypresses overhead; Feipu Pavilion, Wenmei Pavilion, and Lixue Hall each have their own character. Lion Grove Garden integrates Zen meaning, literati refinement, and the beauty of strange rocks, combining Jiangnan elegance with fantasy and playfulness in a truly unique way.',
  'P0',
  '- Adult ticket: CNY 40 in peak season, CNY 30 in off-season
- Discount ticket: CNY 20 in peak season, CNY 15 in off-season (students, seniors aged 60-69 with valid ID)
- Free admission: children under 6 or under 1.4m, seniors aged 70+, active servicemen, and people with disabilities (valid ID required)
- Peak season: April, May, July, August, September, October; off-season: January, February, March, June, November, December
- Note: Prices are subject to on-site announcement. Advance booking is recommended',
  NULL,
  '- Peak season (April, May, July–October): 07:30–17:30 (ticket sales and entry stop at 17:00)
- Off-season (January–March, June, November, December): 07:30–17:00 (ticket sales and entry stop at 16:30)',
  NULL,
  FALSE,
  '- Metro: Take Metro Line 4 to Beisi Pagoda Station and walk about 15 minutes; or take Line 1 to Lindun Road Station and transfer to bus or walk 15–20 minutes
...
- Taxi/ride-hailing: Set destination to “No. 23 Yuanlin Road, Lion Grove Garden”',
  ...
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 23 Yuanlin Road, Gusu District, Suzhou, Jiangsu Province, China',
  '江苏省苏州市姑苏区园林路23号',
  0,
  'com.chinago.travel.attraction.suzhou_lion_grove_garden',
  2,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('suzhou_canglang_pavilion',
  'suzhou',
  'Canglang Pavilion Scenic Area / Surging Wave Pavilion',
  '沧浪亭景区',
  'garden',
  'attractions/suzhou_canglang_pavilion.png',
  'The oldest surviving classical garden in Suzhou, renowned for its open waterfront layout and Song-dynasty elegance where scenery greets visitors before they even enter.',
...
Canglang Pavilion preserves the spacious, natural style of Song-dynasty gardens while embodying the literati ideal of reclusion. Strolling along its stone paths among ancient trees, visitors can appreciate both the garden-making wisdom of creating a world within a small space and the Chinese scholarly pursuit of spiritual transcendence through nature.',
  'P1',
  '- Adult ticket: CNY 20 per person
- Discount ticket: CNY 10 per person (students, seniors aged 60-69 with valid ID)
- Free admission: children under 6 or under 1.4m, seniors aged 70+, active servicemen, and people with disabilities (valid ID required)
- Note: Prices are subject to on-site announcement',
  NULL,
  '- March 1 – October 31: 07:30–17:30 (ticket sales and entry stop at 17:00)
- November 1 – February 28: 07:30–17:00 (ticket sales and entry stop at 16:30)',
  NULL,
  FALSE,
  '- Metro: Take Metro Line 3 or Line 4 to Canglangting Station, then walk about 5–8 minutes
...
- Taxi/ride-hailing: Set destination to “No. 3 Canglangting Street” or “Canglang Pavilion Scenic Area”',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "07:30–17:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 3, Canglangting Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 3 Canglangting Street, Gusu District, Suzhou, Jiangsu Province, China',
  '江苏省苏州市姑苏区沧浪亭街3号',
  0,
  'com.chinago.travel.attraction.suzhou_canglang_pavilion',
  3,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
- Note: Prices are subject to on-site announcement',
  ...
  - Peak season (April, May, July–October): 07:30–17:30 (ticket sales and entry stop at 17:00)
  - Off-season (January–March, June, November, December): 07:30–17:00 (ticket sales and entry stop at 16:30)
- Night Garden: generally open from around March to November, approximately 19:30–22:00; specific sessions subject to official announcement',
  NULL,
  FALSE,
  '- Metro: Take Metro Line 5 to Nanyuan North Road Station and walk 8–10 minutes; or take Line 4 to Sanyuanfang Station and walk about 15 minutes
...
- Taxi/ride-hailing: Set destination to “No. 11 Kuojiatou Lane, Master-of-Nets Garden”',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "07:30–17:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 5, Nanyuan North Road Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 11 Kuojiatou Lane, Gusu District, Suzhou, Jiangsu Province, China',
  '江苏省苏州市姑苏区阔家头巷11号',
  0,
  'com.chinago.travel.attraction.suzhou_master_of_nets_garden',
  4,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('suzhou_huanxiu_mountain_villa',
  'suzhou',
  'Huanxiu Mountain Villa',
  '环秀山庄',
  'garden',
  'attractions/suzhou_huanxiu_mountain_villa.png',
  'Famed for its “thousand-li landscape within a foot” lake-rock mountain, it is regarded as the pinnacle of rockery art in Chinese gardens.',
  'Located at No. 272 Jingde Road, Gusu District, Suzhou, Huanxiu Mountain Villa sits in the bustling old city yet offers tranquil seclusion. It is a UNESCO World Heritage site combining residence, garden, and artificial mountain. Its history dates back to the Wuyue period of the Five Dynasties, when it was the site of the Qian family''s Jingu Garden. After repeated renovations during the Ming and Qing dynasties, the present garden layout was largely formed in the Qing Dynasty.
...
Buildings such as Bu Qiu Fang, Ban Tan Qiu Shui Yi Fang Shan, and You Gu Tang are arranged according to the terrain, blending with the rockery to form a three-dimensional landscape painting. Though compact, Huanxiu Mountain Villa epitomizes the Jiangnan garden principle of “seeing the large within the small,” making it an invaluable example for studying classical Chinese rockery art.',
  'P1',
  '- Adult ticket: CNY 15 per person
- Discount ticket: CNY 7.5 per person (students, seniors aged 60-69 with valid ID)
- Free admission: children under 6 or under 1.4m, seniors aged 70+, active servicemen, and people with disabilities (valid ID required)
- Note: Closed on Mondays (except public holidays). Prices are subject to on-site announcement',
  NULL,
  '- Year-round: 08:30–16:30 (ticket sales and entry stop at 16:00)
- Closed on Mondays (except public holidays)',
  'Closed on Mondays (except public holidays)',
  FALSE,
  '- Metro: Take Metro Line 1 to Yangyuxiang or Lindun Road station and walk 10–15 minutes; or take Line 4 to Chayuanchang station and walk about 8 minutes
...
- Taxi/ride-hailing: Set destination to “No. 272 Jingde Road, Huanxiu Mountain Villa”',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "08:30–16:30"}, {"icon": "❌", "label": "Closed", "value": "Mondays"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1, Yangyuxiang or Lindun Road station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 272 Jingde Road, Gusu District, Suzhou, Jiangsu Province, China (inside Suzhou Embroidery Museum)',
  '江苏省苏州市姑苏区景德路272号（苏州刺绣博物馆内）',
  0,
  'com.chinago.travel.attraction.suzhou_huanxiu_mountain_villa',
  5,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('suzhou_ou_garden',
  'suzhou',
  'Couple''s Retreat Garden / Ou Yuan',
  '耦园（又称藕园）',
  'garden',
  'attractions/suzhou_ou_garden.png',
  'Suzhou''s most romantic “garden of love,” whose name and paired eastern-western layout symbolize conjugal harmony.',
...
Couple''s Retreat Garden is not only one of Suzhou''s most distinctive gardens but also a vivid expression of the Jiangnan literati ideal of retirement. Its steles, couplets, and lattice windows exude scholarly charm. The famous couplet “Ou Yuan houses a fine couple; the city corner builds a poetic city” captures the owners'' vision of harmonious married life. Today, the garden is a popular spot for wedding photography and romantic visits.',
  'P1',
  '- Adult ticket: CNY 25 per person
- Discount ticket: CNY 12.5 per person (students, seniors aged 60-69 with valid ID)
- Free admission: children under 6 or under 1.4m, seniors aged 70+, active servicemen, and people with disabilities (valid ID required)
- Note: Prices are subject to on-site announcement. Advance booking via official channels is recommended',
  NULL,
  '- Peak season (March 1 – October 31): 07:30–17:30 (ticket sales and entry stop at 17:00)
- Off-season (November 1 – February 28): 07:30–17:00 (ticket sales and entry stop at 16:30)',
  NULL,
  FALSE,
  '- Metro: Take Metro Line 1 to Xiangmen Station and walk about 10 minutes along Cang Street; or take Line 6 to Lindun Road Station and walk about 8 minutes
...
- Taxi/ride-hailing: Set destination to “No. 6 Xiaoxinqiao Lane, Cang Street, Couple''s Retreat Garden”',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "07:30–17:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1, Xiangmen Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 6 Xiaoxinqiao Lane, Cang Street, Gusu District, Suzhou, Jiangsu Province, China',
  '江苏省苏州市姑苏区仓街小新桥巷6号',
  0,
  'com.chinago.travel.attraction.suzhou_ou_garden',
  6,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('suzhou_yi_garden',
  'suzhou',
  'Arts Garden / Yi Pu',
  '艺圃',
  'garden',
  'attractions/suzhou_yi_garden.png',
  'A Ming-dynasty garden hidden deep in Suzhou''s old city lanes, celebrated for its tranquil simplicity, mirror-like pond, and authentic literati atmosphere.',
  'Located at No. 5 Wenya Lane, Gusu District, Suzhou, Arts Garden is hidden in a deep alley inside Changmen. It was founded during the Jiajing reign of the Ming Dynasty by Yuan Zugeng as a residential garden named Zuiying Hall. It later changed hands several times, becoming known as Yaopu and then Yi Pu. The present layout was largely formed during the Ming and Qing dynasties. In 2000, it was added to the UNESCO World Heritage List as an extension of the Classical Gardens of Suzhou.
...
The garden''s greatest charm lies in its “hidden in the city” character. Unlike more famous Suzhou gardens, it has no grand entrance and is tucked away in a narrow lane; visitors must wander through old alleys to find it. Once inside, the noise of the city fades, replaced by the sounds of water and birds. This unadorned, secluded atmosphere makes Arts Garden a favorite among locals and an ideal place to experience the authentic spirit of Jiangnan literati gardens.',
  'P1',
  '- Adult ticket: CNY 10 per person
...
- Off-season (November 1 – February 28): 07:30–17:00 (ticket sales and entry stop at 16:30)',
  NULL,
  FALSE,
  '- Metro: Take Metro Line 1 to Guangjinan Road Station and walk 10–15 minutes; or take Line 2 to Shilu Station and walk about 15 minutes
...
- Taxi/ride-hailing: Set destination to “No. 5 Wenya Lane, Arts Garden”',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "07:30–17:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1, Guangjinan Road Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 5 Wenya Lane, inside Changmen, Gusu District, Suzhou, Jiangsu Province, China',
  '江苏省苏州市姑苏区阊门内文衙弄5号',
  0,
  'com.chinago.travel.attraction.suzhou_yi_garden',
  7,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
Despite its small size, Retreat & Reflection Garden is exquisitely conceived, with every rockery, plant, pavilion, and corridor carefully designed. The garden also preserves fine brick, wood, and stone carvings that reflect the high craftsmanship of late-Qing Jiangnan private gardens. It is not only the highlight of Tongli Ancient Town but also an important window into the complex psychology of traditional Chinese literati balancing public service and reclusion.',
  'P1',
  '- Separate ticket: CNY 30 per person
...
- Specific hours are subject to Tongli Ancient Town announcements',
  NULL,
  FALSE,
  '- Metro + bus: Take Metro Line 4 to Tongli Station, then transfer to bus 720, 725, or 735 to Tongli Ancient Town Shipailou stop, and walk into the ancient town along Zhuhang Street
...
- Taxi/ride-hailing: Set destination to “Retreat & Reflection Garden, Tongli Ancient Town” or “No. 1 Renjia Lane, Zhuhang Street, Tongli”',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "08:00–20:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 4, Tongli Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 1 Renjia Lane, Zhuhang Street, Tongli Town, Wujiang District, Suzhou, Jiangsu Province, China (inside Tongli Ancient Town)',
  '江苏省苏州市吴江区同里镇竹行街任家弄1号（同里古镇内）',
  0,
  'com.chinago.travel.attraction.suzhou_tuisi_garden',
  8,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('suzhou_museum',
  'suzhou',
  'Suzhou Museum',
  '苏州博物馆',
  'museum',
  'attractions/suzhou_museum.png',
  'A modern garden-style museum designed by master architect I. M. Pei, blending Suzhou''s history, art, and architectural beauty.',
  'Located at No. 204 Northeast Street, Gusu District, Suzhou, Suzhou Museum was founded in 1960 and is one of China''s renowned comprehensive history and art museums. In October 2006, a new building designed by world-famous architect I. M. Pei opened, connected to the former mansion of Li Xiucheng of the Taiping Heavenly Kingdom, a national key cultural relic protection site. This creates a unique dialogue between old and new, past and present.
...
The building itself is one of the museum''s greatest highlights. I. M. Pei''s design concept was “Chinese yet new, Suzhou yet new,” combining traditional Suzhou garden features—white walls, black tiles, rockeries, and ponds—with modern geometric forms, steel structures, and glass lighting. The central courtyard''s stone hill, built from cut Taishan stones, evokes an ink-wash landscape. Skylights flood the central hall and galleries with soft natural light. Suzhou Museum is both a window into the city''s history and culture and a masterpiece of contemporary architecture integrated with classical gardens.',
  'P0',
  '- Suzhou Museum main building: free admission
...
- Note: Entry without reservation is not permitted. Booking 7 days in advance is recommended for holidays',
  NULL,
  '- Tuesday to Sunday: 09:00–17:00 (entry stops at 16:00)
- Closed on Mondays (except public holidays)
- Special events or night openings are subject to official announcements',
  'Closed on Mondays (except public holidays)',
  TRUE,
  '- Metro: Take Metro Line 4 to Beisi Pagoda Station and walk 10–15 minutes; or take Line 6 to Humble Administrator''s Garden Station and walk about 8 minutes
...
- Taxi/ride-hailing: Set destination to “No. 204 Northeast Street, Suzhou Museum”',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "09:00–17:00"}, {"icon": "❌", "label": "Closed", "value": "Mondays"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 4, Beisi Pagoda Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 204 Northeast Street, Gusu District, Suzhou, Jiangsu Province, China',
  '江苏省苏州市姑苏区东北街204号',
  0,
  'com.chinago.travel.attraction.suzhou_museum',
  9,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
The street is lined with historic sites and cultural spaces, including Couple''s Retreat Garden, the Shanxi Guild Hall, the Kunqu Opera Museum, the Pingtan Museum, and the Number One Scholar Museum. Today, Pingjiang Road blends traditional crafts, time-honored brands, and Suzhou-style snacks with independent bookstores, cafés, creative shops, and boutique guesthouses. Whether it''s morning tea fragrance, afternoon Pingtan performances, or lantern-lit riverbanks at night, Pingjiang Road offers a vivid taste of Suzhou''s unhurried lifestyle and cultural depth.',
  'P1',
  '- The street is open to the public free of charge, 24 hours a day
- Some internal attractions, museums, guild halls, and gardens charge separate admission fees; check on-site notices
- Boat rides: charged separately according to posted rates',
  NULL,
  '- The street is open 24 hours a day
- Shops, restaurants, and museums along the street generally operate from 09:00 to 22:00; hours vary by venue',
  NULL,
  FALSE,
  '- Metro: Take Metro Line 1 to Xiangmen or Lindun Road station and walk 5–10 minutes to Pingjiang Road
...
- Taxi/ride-hailing: Set destination to “Pingjiang Road” or “Pingjiang Road Historical Block (Xiangmen Entrance)”',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1, Xiangmen or Lindun Road station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'Pingjiang Road, Gusu District, Suzhou, Jiangsu Province, China (from Ganjiang Road in the south to Baita East Road in the north)',
  '江苏省苏州市姑苏区平江路（南起干将路，北至白塔东路）',
  0,
  'com.chinago.travel.attraction.suzhou_pingjiang_road',
  10,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('suzhou_zhouzhuang_ancient_town',
  'suzhou',
  'Zhouzhuang Ancient Town',
  '周庄古镇',
  'sight',
  'attractions/suzhou_zhouzhuang_ancient_town.png',
  'Known as China''s Number One Water Town, famed for its well-shaped waterways, Ming-Qing bridges, and grand waterside mansions such as Shen Hall and Zhang Hall.',
  'Located in Zhouzhuang Town, Kunshan City, Suzhou, between Shanghai, Suzhou, and Hangzhou, Zhouzhuang Ancient Town is one of the six great ancient water towns of Jiangnan and one of China''s earliest and best-known water towns. Founded in 1086 during the Northern Song Dynasty, it was originally called Zhenfeng Li and was later renamed Zhouzhuang in honor of local official Zhou Digong, who donated land for a temple.
...
- Free admission: children under 6 or under 1.4m, seniors aged 70+, active servicemen, and people with disabilities (valid ID required)
- Note: Tickets are valid on the day of purchase and allow multiple entries within ticket-selling hours. Prices are subject to on-site announcement',
  NULL,
  '- Scenic area: 08:00–21:00
- Ticket sales: 08:00–17:00
- Opening hours of individual attractions vary; check on-site notices
- Night tours are subject to official announcements',
  NULL,
  FALSE,
  '- High-speed/regular train: Take a high-speed train to Kunshan South Station and transfer by bus or taxi to Zhouzhuang, about 40 minutes; or take a regular train to Kunshan Station and transfer to bus 133 or tourist line 7
...
- Taxi/ride-hailing: Set destination to “No. 43 Quanfu Road, Zhouzhuang Ancient Town” or “Zhouzhuang Ancient Archway”',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "08:00–21:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 7"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 43 Quanfu Road, Zhouzhuang Town, Kunshan City, Suzhou, Jiangsu Province, China',
  '江苏省苏州市昆山市周庄镇全福路43号',
  0,
  'com.chinago.travel.attraction.suzhou_zhouzhuang_ancient_town',
  11,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
The town is rich in cultural relics. The Retreat & Reflection Garden is its crown jewel and a UNESCO World Heritage site. Other highlights include Chongben Hall, Jiayin Hall, the Three Bridges (Taiping, Jili, and Changqing), Pearl Tower Garden, Gengle Hall, and Songshi Wuyuan. Ming-Qing Street is lined with shops offering local delicacies such as Taihu''s “three whites” (whitefish, white shrimp, and whitebait), Sock-Sole Crisp, and Scholar''s Trotter. Whether boating along the canals, strolling across stone bridges, or staying in a waterside inn, Tongli offers an immersive experience of Jiangnan''s gentle beauty and tranquility.',
  'P1',
  '- Ancient town ticket: CNY 100 per person (valid on the day of purchase; includes access to paid attractions within the town)
...
- Free admission: children under 6 or under 1.4m, seniors aged 70+, active servicemen, and people with disabilities (valid ID required)
- Note: Prices and policies are subject to on-site announcement',
  NULL,
  '- Scenic area: 08:00–17:15 year-round
- Opening hours of individual attractions within the town vary; check on-site notices
- Night tours and evening activities are subject to official announcements',
  NULL,
  FALSE,
  '- Metro: Take Metro Line 4 to Tongli Station, then transfer to Wujiang Smart Rail T1 or bus routes 725, 735, 720, or 759 to Tongli Ancient Town or Shipailou stops
...
- Taxi/ride-hailing: Set destination to “No. 1 Zhongchuan South Road, Tongli Ancient Town” or “Tongli Ancient Town Shipailou”',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕘", "label": "Opening Hours", "value": "08:00–17:15"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 4, Tongli Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 1 Zhongchuan South Road, Wujiang District, Suzhou, Jiangsu Province, China (Tongli Ancient Town Scenic Area)',
  '江苏省苏州市吴江区中川南路1号（同里古镇景区）',
  0,
  'com.chinago.travel.attraction.suzhou_tongli_ancient_town',
  12,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
