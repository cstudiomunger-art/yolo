-- Seed: beijing attractions only (standalone upsert)
-- Source: 114_seed_beijing_attractions.sql
...
) VALUES ('beijing_forbidden_city',
  'beijing',
  'The Forbidden City (Palace Museum)',
  '故宫',
  'palace',
  'attractions/beijing_forbidden_city.png',
  'The largest and most completely preserved ancient wooden structural complex in the world, the royal palace of 24 emperors of the Ming and Qing dynasties. With red walls and yellow tiles, resplendent and magnificent, it is the highest symbol of five thousand years of Chinese civilization and the "cultural totem" in every Chinese person''s heart.',
  'The Forbidden City is located in the center of Beijing, formerly known as the Purple Forbidden City. It was first built in the fourth year of the Yongle period of the Ming Dynasty (1406 AD), taking 14 years to complete.',
  'P0',
  '- Peak season (April 1-October 31): 60 RMB/person
...
- Important Note: The Forbidden City implements real-name staggered time slot reservation ticket purchase, which requires reservation on the official website (www.dpm.org.cn) or the "Palace Museum" WeChat Mini Program 10 days in advance; on-site ticket sales are no longer available; daily visitor flow is limited to 80,000 people, and tickets for holidays are extremely tight; it is recommended to plan your itinerary in advance and make reservations as early as possible',
  'Note: Visiting the Forbidden City requires at least 3-4 hours; if you want to savor it carefully, it is recommended to allow a full day; recommended visiting route: Meridian Gate (entrance) → Wumen Square → Hall of Supreme Harmony → Hall of Central Harmony → Hall of Preserving Harmony → Palace of Heavenly Purity → Hall of Union → Palace of Earthly Tranquility → Imperial Garden → Gate of Divine Might (exit); it is recommended to arrange visiting the Treasure Gallery and Clock and Watch Gallery in the afternoon',
...
- Note: The entrance of the Forbidden City is at the Meridian Gate (south side), and the exit is at the Gate of Divine Might (north side); after finishing the visit, you can exit from the Gate of Divine Might, walk to Jingshan Park to overlook the panoramic view of the Forbidden City, or continue visiting places such as Shichahai and Nanluoguxiang; parking spaces around the Forbidden City are extremely tight; it is strongly recommended to take rail transit or bus',
  '[{"icon": "🎫", "label": "Ticket", "value": "60 / 40 RMB"}, {"icon": "🕐", "label": "Duration", "value": "3–4 hours"}, {"icon": "🕘", "label": "Opening Hours", "value": "08:30–17:00"}, {"icon": "❌", "label": "Closed", "value": "Mondays"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1, Tiananmen East Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 4 Jingshan Front Street, Dongcheng District, Beijing (north side of Tiananmen Square)',
  '北京市东城区景山前街4号（天安门广场北侧）',
  0,
  'com.chinago.travel.attraction.beijing_forbidden_city',
  0,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('beijing_temple_of_heaven',
  'beijing',
  'Temple of Heaven',
  '天坛',
  'temple',
  'attractions/beijing_temple_of_heaven.png',
  'The sacred site where emperors of the Ming and Qing dynasties offered sacrifices to heaven and prayed for good harvests. With the "round heaven and square earth" cosmology as its design soul, the triple-tiered blue-tiled circular roof of the Hall of Prayer for Good Harvests, the acoustic wonder of the Echo Wall, and the ninefold heavenly intent of the Circular Mound Altar together compose a magnificent architectural epic of "dialogue between man and heaven."',
  'The Temple of Heaven is located on the east side of Yongdingmen Inner Street in Dongcheng District, Beijing.',
  'P0',
  '- Peak season (April 1-October 31): 15 RMB/person (including Hall of Prayer for Good Harvests, Echo Wall, Circular Mound Altar)
...
- Discounted Tickets: Students, seniors (over 60), military personnel, etc. can enjoy half-price or free admission with valid ID
- Note: It is recommended to purchase tickets in advance on the official website or WeChat account for discounts and to avoid on-site queuing; Tiantan covers a large area, so it is recommended to allow 2-3 hours for visiting; if you want to experience the leisure life of old Beijing citizens, it is recommended to go in the early morning or evening',
  NULL,
...
- Note: Transportation around Tiantan is extremely convenient, with dense rail transit and bus routes; it is strongly recommended to take public transportation; Tiantan has multiple entrances, and you can choose the most convenient entrance to enter according to your subsequent itinerary arrangements',
  '[{"icon": "🎫", "label": "Ticket", "value": "15 / 10 RMB"}, {"icon": "🕘", "label": "Opening Hours", "value": "06:00–21:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 5, Tiantan East Gate Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 7 Tiantan Neidong Li, Dongcheng District, Beijing (east side of Yongdingmen Inner Street)',
  '北京市东城区天坛内东里7号（永定门内大街东侧）',
  0,
  'com.chinago.travel.attraction.beijing_temple_of_heaven',
  1,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('beijing_summer_palace',
  'beijing',
  'Summer Palace',
  '颐和园',
  'garden',
  'attractions/beijing_summer_palace.png',
  '"The Museum of Imperial Gardens," built on the basis of Kunming Lake and Longevity Hill, absorbing the essence of Jiangnan gardens and bringing together the quintessence of garden art from across the country. The colored paintings of the Long Corridor, the towering majesty of the Buddha Fragrance Pavilion, and the graceful elegance of the Seventeen-Arch Bridge together paint an iconic long scroll of landscape poetry.',
  'The Summer Palace is located in Haidian District, Beijing, about 15 kilometers from Beijing urban area, about 40-60 minutes'' drive.',
  'P0',
  '- Peak season (April 1-October 31): 30 RMB/person
...
- Discounted Tickets: Students, seniors (over 60), military personnel, etc. can enjoy half-price or free admission with valid ID
- Note: It is recommended to purchase tickets in advance on the official website or WeChat account for discounts and to avoid on-site queuing; the Summer Palace covers a large area, so it is recommended to allow at least 3-4 hours for visiting, and it is best to arrange a full day if you want to savor it carefully',
  NULL,
...
- Note: The Summer Palace has multiple entrances, and you can choose the most convenient entrance to enter according to your subsequent itinerary arrangements; roads in the surrounding area are extremely prone to congestion on weekends and holidays, and parking spaces are tight; it is strongly recommended to take rail transit or bus; entering from Beigongmen is closest to the Buddha Fragrance Pavilion',
  '[{"icon": "🎫", "label": "Ticket", "value": "60 / 20 RMB"}, {"icon": "🕘", "label": "Opening Hours", "value": "06:30–18:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 4, Xiyuan Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 19 Xinjiangongmen Road, Haidian District, Beijing (central part of Haidian District, outside the Fourth Ring Road)',
  '北京市海淀区新建宫门路19号（海淀区中部，四环外）',
  0,
  'com.chinago.travel.attraction.beijing_summer_palace',
  2,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('beijing_national_museum',
  'beijing',
  'National Museum of China',
  '国博',
  'museum',
  'attractions/beijing_national_museum.png',
  'One of the largest museums in the world, collecting over 1.4 million artifacts spanning China''s general history. From the teeth of Yuanmou Man to the contemporary achievements of the "Road to Rejuvenation," it is a "standing five-thousand-year civilization history of China."',
  'The National Museum of China (abbreviated as "National Museum") is located on the east side of Tiananmen Square in the center of Beijing, facing the Great Hall of the People to the east and west.',
  'P0',
  '- Admission: Free admission (advance reservation required)
...
- Important Note: The National Museum implements real-name reservation for visiting, which requires reservation on the official website (www.chnmuseum.cn) or the "National Museum" WeChat account/Mini Program 7 days in advance. Each day is divided into morning session (09:00-13:00) and afternoon session (13:00-17:00), and reservations close once full; valid ID must be brought when entering the museum, and security checks are required',
...
- Note: The National Museum is located on the east side of Tiananmen Square; roads in the surrounding area are frequently under traffic control, and parking spaces are extremely tight; it is strongly recommended to take rail transit or bus; after visiting the National Museum, you can顺便 visit attractions such as Tiananmen Square, the Forbidden City, Zhongshan Park, and Beihai Park',
  '[{"icon": "🎫", "label": "Ticket", "value": "50 RMB"}, {"icon": "🕐", "label": "Duration", "value": "3–4 hours"}, {"icon": "🕘", "label": "Opening Hours", "value": "09:00–17:00"}, {"icon": "❌", "label": "Closed", "value": "Mondays"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1, Tiananmen East Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 16 East Chang''an Street, Dongcheng District, Beijing (east side of Tiananmen Square, opposite the Great Hall of the People)',
  '北京市东城区东长安街16号（天安门广场东侧，人民大会堂对面）',
  0,
  'com.chinago.travel.attraction.beijing_national_museum',
  3,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('beijing_mutianyu_great_wall',
  'beijing',
  'Mutianyu Great Wall',
  '慕田峪长城',
  'wall',
  'attractions/beijing_mutianyu_great_wall.png',
  '"Of the ten-thousand-li Great Wall, Mutianyu stands out alone." This well-preserved section of the Ming Great Wall is famous for its dense watchtowers, beautiful mountain forest scenery, and as a filming location for "If You Are the One 2." It offers a more tranquil and pristine Great Wall experience than Badaling.',
  'Mutianyu Great Wall is located in Huairou District, Beijing, about 90 kilometers from Beijing urban area, about 1.5-2 hours'' drive.',
  'P0',
  '- Admission: 45 RMB/person
...
- Note: It is recommended to purchase admission and chairlift/cable car tickets in advance on the official website or travel platforms for discounts and to avoid on-site queuing; visitor flow is larger on weekends and holidays, so weekday visits are recommended',
...
- Note: Mutianyu Great Wall is far from Beijing urban area and inconvenient for transportation; it is strongly recommended to plan round-trip transportation in advance; if you choose to take the tourist special line bus, be sure to remember the return assembly time and place clearly to avoid missing the last bus',
  '[{"icon": "🎫", "label": "Ticket", "value": "45 RMB"}, {"icon": "🕐", "label": "Duration", "value": "3–4 hours"}, {"icon": "🕘", "label": "Opening Hours", "value": "07:30–18:00"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'Mutianyu Village, Bohai Town, Huairou District, Beijing (along the Great Wall in the northern part of Huairou District)',
  '北京市怀柔区渤海镇慕田峪村（怀柔区北部长城沿线）',
  0,
  'com.chinago.travel.attraction.beijing_mutianyu_great_wall',
  4,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('beijing_ming_tombs',
  'beijing',
  'Ming Tombs (Thirteen Tombs of the Ming Dynasty)',
  '十三陵',
  'sight',
  'attractions/beijing_ming_tombs.png',
  'The largest existing imperial tomb architectural complex in the world and the one with the most emperor and empress tombs. The resting place of Ming Chengzu Zhu Di, the mystery of Dingling Underground Palace, the grandeur of Changing Ling''en Hall, and the solemnity of the Sacred Way stone statues together weave this "open-air magnificent historical masterpiece of the Ming Dynasty."',
  'The Ming Tombs are located at the foot of Tianshou Mountain in Changping District, Beijing, about 50 kilometers from Beijing urban area.',
  'P1',
  '- Changing (Tomb of Chengzu Zhu Di): 45 RMB/person
...
- Discounted Tickets: Students, seniors (over 60), military personnel, etc. can enjoy half-price or free admission with valid ID
- Note: It is recommended to purchase tickets in advance on the official website or travel platforms for discounts and to avoid on-site queuing; the Ming Tombs scenic area covers a large area, and the distances between tombs are far; it is recommended to allow a full day for visiting and take internal transportation within the scenic area (electric shuttle bus or tourist bus)',
  'Note: Visiting the Ming Tombs requires at least 4-5 hours (if visiting all open tombs and the Sacred Way); it is recommended to go in the morning; the temperature inside Dingling Underground Palace is relatively low (about 15-18°C), so even if visiting in summer, bringing a thin jacket is recommended',
...
- Note: The Ming Tombs are far from Beijing urban area and inconvenient for transportation; it is strongly recommended to plan round-trip transportation in advance; if you choose self-driving, you can arrange visiting the Ming Tombs and Badaling Great Wall or Juyongguan Great Wall in Yanqing on the same day (the two places are about 40 kilometers apart)',
  '[{"icon": "🎫", "label": "Ticket", "value": "45 RMB"}, {"icon": "🕐", "label": "Duration", "value": "4–5 hours"}, {"icon": "🕘", "label": "Opening Hours", "value": "08:00–17:30"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'Shisanling Town, Changping District, Beijing (foot of Tianshou Mountain, northern part of Changping District)',
  '北京市昌平区十三陵镇（天寿山麓，昌平区北部）',
  0,
  'com.chinago.travel.attraction.beijing_ming_tombs',
  5,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('beijing_lama_temple',
  'beijing',
  'Yonghe Temple (Lama Temple)',
  '雍和宫',
  'temple',
  'attractions/beijing_lama_temple.png',
  'A royal temple that originated as the residence of Emperor Yongzheng of the Qing Dynasty before he ascended the throne, later converted to a Gelug school of Tibetan Buddhism temple. The resplendent halls, lingering butter lamp fragrance, rotating prayer wheels, and devout believers together create the most sacred and tranquil "snow land pure land" within Beijing city.',
  'Yonghe Temple is located on Yonghe Temple Street in Dongcheng District, Beijing. It is the largest and most completely preserved Tibetan Buddhist temple in the Beijing area, and one of the highest-specification and most influential Tibetan Buddhist temples in inland China.',
  'P1',
  '- Admission: 25 RMB/person
- Discounted Tickets: Students, seniors (over 60), military personnel, etc. can enjoy half-price or free admission with valid ID
...
- Note: Yonghe Temple is located in the center of Beijing, with extremely convenient transportation in the surrounding area; it is strongly recommended to take rail transit or bus; after visiting Yonghe Temple, you can顺便 visit attractions such as Ditan Park (south side), Nanluoguxiang (west side), and Guozijian Street (west side); there are many characteristic restaurants and snack shops around Yonghe Temple, and it is recommended to try the Tibetan restaurants and vegetarian restaurants near Yonghe Temple',
  '[{"icon": "🎫", "label": "Ticket", "value": "25 RMB"}, {"icon": "🕘", "label": "Opening Hours", "value": "09:00–16:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 2, Yonghe Temple Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 12 Yonghe Temple Street, Dongcheng District, Beijing (Beixin Bridge area, south side of Ditan Park)',
  '北京市东城区雍和宫大街12号（北新桥地区，地坛公园南侧）',
  0,
  'com.chinago.travel.attraction.beijing_lama_temple',
  6,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('beijing_prince_gong_mansion',
  'beijing',
  'Prince Gong''s Mansion',
  '恭王府',
  'palace',
  'attractions/beijing_prince_gong_mansion.png',
  'The largest and most completely preserved prince''s mansion from the Qing Dynasty, once the "Heshen Villa," famous for the "99 and a Half Rooms" Xijin Hall, the exquisite Western-style gate, and the "Number One Blessing Under Heaven" Fu character stele. It is a living fossil of "One Prince Gong''s Mansion, Half of Qing Dynasty History."',
  'Prince Gong''s Mansion is located on Qianhai West Street in Xicheng District, Beijing, adjacent to Shichahai. It is the largest and most completely preserved prince''s mansion from the Qing Dynasty, first built in the middle and late Qianlong period of the Qing Dynasty (around 1776).',
  'P1',
  '- Admission: 40 RMB/person (including mansion + garden)
- Discounted Tickets: Students, seniors (over 60), military personnel, etc. can enjoy half-price or free admission with valid ID
...
- Note: Prince Gong''s Mansion has a large number of visitors; it is recommended to make a reservation and purchase tickets in advance on the official website or WeChat account, especially on weekends and holidays; daily visitor flow is limited, and there may be no on-site tickets available',
  'Note: Visiting time for Prince Gong''s Mansion is about 1.5-2 hours; it is recommended to go in the morning to avoid the tour group peak in the afternoon; the garden is especially beautiful in autumn, and the photo effect is excellent when ginkgo leaves turn yellow',
...
- Note: Prince Gong''s Mansion is located within the Shichahai scenic area; roads in the surrounding area are narrow and parking spaces are extremely tight; it is strongly recommended to take rail transit or bus; after visiting Prince Gong''s Mansion, you can顺便 visit attractions such as Shichahai, Yandai Skewed Street, and Nanluoguxiang',
  '[{"icon": "🎫", "label": "Ticket", "value": "40 RMB"}, {"icon": "🕐", "label": "Duration", "value": "1.5–2 hours"}, {"icon": "🕘", "label": "Opening Hours", "value": "08:30–17:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 6, Beihai North Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 17 Qianhai West Street, Xicheng District, Beijing (Shichahai area, west side of Di''anmen Outer Street)',
  '北京市西城区前海西街17号（什刹海地区，地安门外大街西侧）',
  0,
  'com.chinago.travel.attraction.beijing_prince_gong_mansion',
  7,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('beijing_beihai_park',
  'beijing',
  'Beihai Park',
  '北海公园',
  'park',
  'attractions/beijing_beihai_park.png',
  'Located to the northwest of the Forbidden City, it is an imperial garden with the White Dagoba on Qionghua Island as its symbol. With lake reflections, pagoda shadows, and swaying lotus flowers, it is the most poetic "urban oasis" in the heart of Beijing.',
  'Beihai Park is located in the center of Beijing, to the northwest of the Forbidden City. Together with Zhonghua and Nanhai, it is called the "Three Seas." It is one of the oldest, most complete, most comprehensive, and most representative imperial gardens in China, first built in the Liao Dynasty (938 AD), and expanded through the Jin, Yuan, Ming, and Qing dynasties, with a history of nearly 1,100 years.',
  'P1',
  '- Peak season (April 1-October 31): 10 RMB/person
...
- Discounted Tickets: Students, seniors (over 60), military personnel, etc. can enjoy half-price or free admission with valid ID
- Note: It is recommended to purchase tickets in advance through the official WeChat account of "Beihai Park" or platforms such as Meituan and Ctrip to avoid on-site queuing; the park covers a large area, so it is recommended to allow 2-3 hours for visiting',
  NULL,
...
- Note: Summer evening is the most beautiful time in Beihai Park, with the sunset shining on the lake and the White Dagoba glowing in the golden afterglow; in winter, after the lake surface freezes, you can experience ice cariage (additional fee required)',
  NULL,
  FALSE,
  '- Rail Transit:
  - Subway Line 6: Get off at Beihai North Station, walk about 5 minutes from Exit B (Northeast Exit)
...
- Note: Roads around Beihai Park are narrow and parking spaces are extremely tight; it is strongly recommended to take rail transit or bus; entering from the North Gate is closest to Qionghua Island',
  '[{"icon": "🎫", "label": "Ticket", "value": "20 / 5 RMB"}, {"icon": "🕘", "label": "Opening Hours", "value": "06:30–21:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 6, Beihai North Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 1 Wenjin Street, Xicheng District, Beijing (northwest side of the Forbidden City, west side of Shichahai)',
  '北京市西城区文津街1号（故宫西北侧，什刹海西侧）',
  0,
  'com.chinago.travel.attraction.beijing_beihai_park',
  8,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
