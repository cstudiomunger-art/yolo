...
- **Special note:** Closed on Mondays for maintenance (except for statutory holidays); reservation slots may be tight during holidays, advance reservation is recommended',
  NULL,
...
- **Tip:** The Sun Yat-sen Mausoleum is located within the Purple Mountain Scenic Area. It is recommended to arrange visits to Ming Xiaoling Mausoleum, Linggu Temple and other attractions on the same day, and give priority to public transportation or scenic area sightseeing buses',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕐", "label": "Duration", "value": "1.5–2 hours"}, {"icon": "🕘", "label": "Opening Hours", "value": "8:30–17:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 2, Muxuyuan Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'Inside Purple Mountain Scenic Area, Shixiang Road, Xuanwu District, Nanjing, Jiangsu Province',
  '江苏省南京市玄武区石象路钟山风景名胜区内',
  0,
  'com.chinago.travel.attraction.nanjing_sun_yat_sen_mausoleum',
  0,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('nanjing_museum',
  'nanjing',
  'Nanjing Museum',
  '南京博物院',
  'museum',
  'attractions/nanjing_museum.png',
  'Nanjing Museum is one of China''s three major museums and one of the first national first-class museums. Its predecessor was the National Central Museum advocated by Mr. Cai Yuanpei in 1933. It houses over 430,000 precious cultural relics, with bronzes, porcelain, and calligraphy and paintings as its three major features. It is an important window for displaying Chinese civilization.',
  'Nanjing Museum is located at No. 321 Zhongshan East Road, Xuanwu District, Nanjing, at the southern foot of Purple Mountain and beside the Zhongshan Scenic Area. It is one of China''s three major museums, one of the first national first-class museums, a national key museum jointly built by the central and local governments, and a national AAAA-level tourist attraction.
...
- **Tip:** Reservation slots may be tight during holidays. It is recommended to make a reservation 3—7 days in advance',
  NULL,
  '- **Opening hours:** Daily 9:00—17:00 (last ticket check at 16:00)
- **Closing time:** Closed on Mondays (except for statutory holidays); closed on New Year''s Eve and the first day of the Lunar New Year
...
- **Recommended visiting time:** Half a day to a full day',
  NULL,
  TRUE,
  '- **Metro:**
...
- **Tip:** Nanjing Museum is one of Nanjing''s most popular cultural venues. The visitor flow is extremely large during holidays. It is recommended to give priority to public transportation and complete the reservation in advance',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 2, Minggugong Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 321 Zhongshan East Road, Xuanwu District, Nanjing, Jiangsu Province',
  '江苏省南京市玄武区中山东路321号',
  0,
  'com.chinago.travel.attraction.nanjing_museum',
  1,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
The scenic area also features characteristic Jinling snacks, such as duck blood vermicelli soup, beef pot stickers, red bean wine-brewed yuanxiao, etc., making it a paradise for food lovers.',
  'P0',
  '- **Public areas of the scenic area:** Free admission
...
- **Tip:** Tickets for attractions may be tight during holidays. Advance online ticket purchase or reservation is recommended',
  NULL,
...
- **Recommended visiting time:** Half a day to a full day; it is recommended to visit from evening to night, so you can enjoy both daytime scenery and night lighting',
  NULL,
  TRUE,
  '- **Metro:**
...
- **Tip:** The Confucius Temple - Qinhuai River Scenic Area is one of Nanjing''s most popular tourist areas. The visitor flow is extremely large during holidays. It is recommended to avoid peak hours or choose public transportation',
  '[{"icon": "🎫", "label": "Ticket", "value": "30 RMB"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1, Sanshan Street Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'Gongyuan Street, Qinhuai District, Nanjing, Jiangsu Province (Confucius Temple Central Scenic Area)',
  '江苏省南京市秦淮区贡院街（夫子庙中心景区）',
  0,
  'com.chinago.travel.attraction.nanjing_confucius_temple_qinhuai',
  2,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('nanjing_ming_xiaoling',
  'nanjing',
  'Ming Xiaoling Mausoleum, Nanjing',
  '南京明孝陵',
  'sight',
  'attractions/nanjing_ming_xiaoling.png',
  'Ming Xiaoling Mausoleum in Nanjing is the tomb of Emperor Zhu Yuanzhang (the founding emperor of the Ming Dynasty) and Empress Ma. It is one of the largest imperial mausoleums in China and pioneered the basic layout of imperial mausoleums of the Ming and Qing dynasties, known as "The First Imperial Mausoleum of the Ming and Qing Dynasties."',
  'Ming Xiaoling Mausoleum is located in the Purple Mountain Scenic Area in Xuanwu District, Nanjing. It is the tomb of Emperor Zhu Yuanzhang (the founding emperor of the Ming Dynasty) and Empress Ma. Construction began in the 14th year of the Hongwu reign of the Ming Dynasty (1381) and was basically completed in the 3rd year of the Yongle reign (1405), taking 25 years and mobilizing more than 100,000 military workers.
...
In July 2003, after deliberation and approval at the 27th session of the UNESCO World Heritage Committee, Ming Xiaoling Mausoleum was officially inscribed on the UNESCO World Heritage List as an extension project of "Imperial Tombs of the Ming and Qing Dynasties." Today, Ming Xiaoling Mausoleum is not only an important historical and cultural landmark in Nanjing, but also a must-visit place for Chinese and foreign tourists to feel the atmosphere of the Ming Dynasty and appreciate the charm of the ancient capital of six dynasties. In spring and autumn, the stone elephant spirit way in the mausoleum area has fiery maple leaves and golden ginkgo, and the scenery is especially magnificent.',
  'P0',
  '- **Ticket price:** 70 RMB/person (60 RMB/person during Plum Blossom Festival)
...
- **Tip:** Tickets are valid on the day of visit. Re-entry after leaving the park requires repurchasing tickets',
...
- **Tip:** The Purple Mountain Scenic Area covers a large area. It is recommended to reserve sufficient time and give priority to public transportation or scenic area sightseeing buses',
  '[{"icon": "🎫", "label": "Ticket", "value": "70 / 60 RMB"}, {"icon": "🕐", "label": "Duration", "value": "2–3 hours"}, {"icon": "🕘", "label": "Opening Hours", "value": "6:30–18:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 2, Muxuyuan Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'Ming Xiaoling Mausoleum Scenic Area, Purple Mountain Scenic Area, Xuanwu District, Nanjing, Jiangsu Province (at the foot of Wanju Peak, Dulongfu, on the southern slope of Purple Mountain)',
  '江苏省南京市玄武区钟山风景名胜区-明孝陵景区（钟山南麓独龙阜玩珠峰下）',
  0,
  'com.chinago.travel.attraction.nanjing_ming_xiaoling',
  3,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('nanjing_presidential_palace',
  'nanjing',
  'Nanking Presidential Palace (Nanjing Museum of Modern Chinese History)',
  '总统府（南京中国近代史遗址博物馆）',
  'museum',
  'attractions/nanjing_presidential_palace.png',
  'The Presidential Palace is the largest-scale and best-preserved architectural complex of modern Chinese history. It has witnessed multiple important historical periods such as the Taiping Heavenly Kingdom and the Republic of China, and is a "panoramic museum of modern history."',
  'The Presidential Palace is located at No. 292 Changjiang Road, Xuanwu District, Nanjing. It is the largest-scale and best-preserved architectural complex of modern Chinese history, and is now the Museum of Modern Chinese History, as well as a national AAAA-level tourist attraction.
...
- **Tip:** There are many visitors during holidays. Advance online ticket purchase or reservation is recommended to reduce queuing time',
  NULL,
  '- **Opening hours:**
...
- **Tip:** The Presidential Palace is located in the center of Nanjing. The surrounding traffic is relatively congested. Priority should be given to public transportation',
  '[{"icon": "🎫", "label": "Ticket", "value": "35 RMB"}, {"icon": "🕐", "label": "Duration", "value": "2–3 hours"}, {"icon": "🕘", "label": "Opening Hours", "value": "8:30–18:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 2, Daxinggong Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 292 Changjiang Road, Xuanwu District, Nanjing, Jiangsu Province',
  '江苏省南京市玄武区长江路292号',
  0,
  'com.chinago.travel.attraction.nanjing_presidential_palace',
  4,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('nanjing_massacre_memorial',
  'nanjing',
  'Memorial Hall of the Victims in Nanjing Massacre by Japanese Invaders',
  '侵华日军南京大屠杀遇难同胞纪念馆',
  'museum',
  'attractions/nanjing_massacre_memorial.png',
  'The Memorial Hall of the Victims in Nanjing Massacre by Japanese Invaders is the only memorial hall in China with the Nanjing Massacre as its historical background. Bearing the national memory and vision of peace, it is an important historical witness to the victory of the World Anti-Fascist War.',
  'The Memorial Hall of the Victims in Nanjing Massacre by Japanese Invaders is located at No. 418 Shuiximen Street, Jianye District, Nanjing. Covering an area of about 74,000 square meters, it is one of China''s first national first-class museums, a national demonstration base for patriotic education, and a major historical and cultural site protected at the national level.
...
The memorial hall is open to the public free of charge all year round (closed on Mondays). It is an important place for patriotic education, historical research, and peace exchanges. The National Memorial Ceremony for the Victims of the Nanjing Massacre is held here on December 13 every year, reminding the world to remember history, cherish peace, and create the future.',
  'P0',
  '- **Ticket price:** Free admission (advance reservation required)
...
- **Special note:** Closed on Mondays (open on national statutory holidays); special opening arrangements may be implemented on December 13 (National Memorial Day for Nanjing Massacre Victims), please pay attention to official announcements',
  NULL,
...
- **Recommended visiting time:** 2–3 hours',
  NULL,
  TRUE,
  '- **Metro:** Take Metro Line 2 to Yunjin Road Station, exit at Exit 2 and enter the hall through Gate 1; during statutory holidays and periods of large visitor flow, exit at Exit 3 and enter the hall through Gate 1
...
- **Tip:** Visitor flow is large during holidays and memorial days. Public transportation is recommended, and please complete the reservation in advance',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕐", "label": "Duration", "value": "2–3 hours"}, {"icon": "🕘", "label": "Opening Hours", "value": "8:30–17:30"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 2, Yunjin Road Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
...
- **Former Site of Lijixiang Comfort Women Station Exhibition Area:** No. 2 Liji Lane, Qinhuai District, Nanjing, Jiangsu Province',
  '- **主展区（南京大屠杀史展区、三个必胜展区）：** 江苏省南京市建邺区水西门大街418号
- **利济巷慰安所旧址展区：** 江苏省南京市秦淮区利济巷2号',
  0,
  'com.chinago.travel.attraction.nanjing_massacre_memorial',
  5,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('nanjing_city_wall',
  'nanjing',
  'Nanjing Ming City Wall',
  '南京明城墙',
  'wall',
  'attractions/nanjing_city_wall.png',
  'The Nanjing Ming City Wall was first built in 1366 and is the longest extant ancient city wall in the world. It is also the only capital-level city wall historically built in the Jiangnan region of China. About 25.1 kilometers of basically intact city wall still exist today. It is one of Nanjing''s most iconic historical and cultural heritages.',
  'The Nanjing Ming City Wall was first built in the 9th year of the Hongwu reign of the Ming Dynasty (1366) and was completed in the 26th year of the Hongwu reign (1393). It took 28 years to complete and mobilized the money and grain of 1 chief secretariat, 3 guards, 5 provinces, 28 prefectures, and 152 counties, as well as tens of thousands of military and civilian craftsmen. It is the longest extant ancient city wall in the world and the only capital-level city wall historically built in the Jiangnan region of China.
...
In 2012, the "City Walls of the Ming and Qing Dynasties in China" combined project, including the Nanjing Ming City Wall, was designated by the National Cultural Heritage Administration as a project for the "China World Cultural Heritage Tentative List."',
  'P1',
  '- **Zhonghuamen Wengcheng (Gate Tower):** 50 RMB/person
...
- **Preferential policies:** Seniors over 60 years old, students, military personnel, etc. enjoy discounts with valid documents; children under 6 years old (inclusive) or under 1.4 meters (inclusive) in height are free
- **Tip:** Ticket prices vary for different wall entry points, and some sections are open free of charge. It is recommended to check the ticket information of specific wall entry points in advance',
  NULL,
...
- **Recommended visiting time:** 1—2 hours/section',
  NULL,
  FALSE,
  '- **Zhonghuamen Section:**
...
- **Tip:** The various sections of the Nanjing Ming City Wall are scattered. It is recommended to plan the visiting route in advance and choose 1—2 sections for focused visiting',
  '[{"icon": "🎫", "label": "Ticket", "value": "50 RMB"}, {"icon": "🕐", "label": "Duration", "value": "2 hours"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1, Zhonghuamen Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
...
- **Xuanwumen Section:** Xuanwumen, Xuanwu Lake Park, Xuanwu District, Nanjing, Jiangsu Province',
  '南京明城墙全线分布于南京市多个区，主要登城口地址如下：
- **中华门段：** 江苏省南京市秦淮区中华门城堡
...
- **玄武门段：** 江苏省南京市玄武区玄武湖公园玄武门',
  0,
  'com.chinago.travel.attraction.nanjing_city_wall',
  6,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('nanjing_niushoushan',
  'nanjing',
  'Niushou Mountain Cultural Tourism Zone, Nanjing',
  '南京牛首山文化旅游区',
  'temple',
  'attractions/nanjing_niushoushan.png',
...
Niushou Mountain is not only a famous Buddhist mountain, but also a comprehensive cultural tourism zone integrating natural scenery, historical culture, and leisure vacation. In spring, peach blossoms are in full bloom on Niushou Mountain and new green is all over the fields, making it the first choice for Nanjing people to go for spring outings.',
  'P1',
  '- **Ticket price:** 98 RMB/person (specific prices are subject to official announcements of the scenic area and may be adjusted seasonally)
...
- **Tip:** It is recommended to check the latest ticket prices and preferential policies in advance through official channels',
...
- **Tip:** Niushou Mountain is located in Jiangning District, far from downtown Nanjing. It is recommended to reserve sufficient time and give priority to self-driving or taking a taxi',
  '[{"icon": "🎫", "label": "Ticket", "value": "98 RMB"}, {"icon": "🕐", "label": "Duration", "value": "4 hours"}, {"icon": "🚇", "label": "Metro", "value": "Metro:**"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 18 Ningdan Avenue, Jiangning District, Nanjing, Jiangsu Province',
  '江苏省南京市江宁区宁丹大道18号',
  0,
  'com.chinago.travel.attraction.nanjing_niushoushan',
  7,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('nanjing_laomendong',
  'nanjing',
  'Laomendong Historical and Cultural District',
  '老门东历史文化街区',
  'market',
  'attractions/nanjing_laomendong.png',
  'Laomendong Historical and Cultural District is the core historical and cultural district in the southern part of old Nanjing. Traditional-style Ming and Qing dynasty buildings were reconstructed here. It gathers intangible cultural heritage and characteristic foods, and is an ideal place to experience the local customs and sentiments of old Nanjing.',
  'Laomendong Historical and Cultural District is located east of Zhonghua Gate in Qinhuai District, Nanjing, between the Confucius Temple and the Former Site Park of the Da Bao''en Temple. It gets the name "Mendong" (East of the Gate) because it is located east of the southern gate of Nanjing''s capital city (i.e., Zhonghua Gate), and it is opposite to Laomenxi (West of the Gate).
...
Laomendong is located in the middle of the Confucius Temple, Zhonghua Gate, and the Da Bao''en Temple. They can be visited as a whole to feel the historical changes of Nanjing from the Ming Dynasty to the Qing Dynasty to the Republic of China and then to the present in one go. The district is open free of charge all day long, and is an ideal place to feel the blending temperament of tradition and modernity in Nanjing.',
  'P1',
  '- **Public areas of the district:** Free admission
- **Some exhibition halls/experience projects:** May charge separately, subject to on-site announcements
- **Tip:** Restaurants, cafés, handicraft shops, etc. within the district have separate consumption, subject to actual prices',
  NULL,
...
- **Tip:** Laomendong is located near the Confucius Temple scenic area. It is recommended to arrange visits to the Confucius Temple, Qinhuai River Scenic Area, Zhonghuamen Castle, and other attractions on the same day',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕐", "label": "Duration", "value": "1.5–3 hours"}, {"icon": "🕘", "label": "Opening Hours", "value": "10:00–22:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 3, Wudingmen Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 54 Jianzi Lane, Qinhuai District, Nanjing, Jiangsu Province (Kong Miao Subdistrict)',
  '江苏省南京市秦淮区剪子巷54号（夫子庙街道）',
  0,
  'com.chinago.travel.attraction.nanjing_laomendong',
  8,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('nanjing_ganxi_mansion',
  'nanjing',
  'Gan Xi Residence (Nanjing Folk Custom Museum)',
  '甘熙宅第（南京民俗博物馆）',
  'museum',
  'attractions/nanjing_ganxi_mansion.png',
  'Gan Xi Residence (Nanjing Folk Custom Museum) is the largest extant and best-preserved Qing Dynasty residential building complex in Nanjing. It has long been known as the "Ninety-Nine and a Half Rooms" and is the best window to understand Nanjing''s traditional folk custom culture.',
  'Gan Xi Residence (Nanjing Folk Custom Museum) is located at No. 400 Zhongshan South Road, Xiananli Street, Nanbuting, Qinhuai District, Nanjing. It is the largest extant and best-preserved Qing Dynasty residential building complex in Nanjing and has long been known as the "Ninety-Nine and a Half Rooms."
...
Nanjing Folk Custom Museum is open all day long. The ticket price is about 20 RMB/person. It is an ideal place to understand Nanjing''s traditional folk custom culture and appreciate the architectural art of Qing Dynasty residential buildings.',
  'P1',
  '- **Ticket price:** 20 RMB/person (prices may change due to policy adjustments, subject to on-site announcements)
...
- **Tip:** Gan Xi Residence is located in the core area of old Nanjing''s Chengnan. The surrounding roads are relatively narrow. Priority should be given to public transportation',
  '[{"icon": "🎫", "label": "Ticket", "value": "20 RMB"}, {"icon": "🕐", "label": "Duration", "value": "2 hours"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1, Sanshan Street Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'Nanbuting, Xiananli Street, No. 400 Zhongshan South Road, Qinhuai District, Nanjing, Jiangsu Province (at the intersection of Shengzhou Road)',
  '江苏省南京市秦淮区中山南路400号熙南里街区南捕厅（升州路口）',
  0,
  'com.chinago.travel.attraction.nanjing_ganxi_mansion',
  9,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
INSERT INTO attractions (
  ...
  requires_advance_booking, metro_access, practical_info, western_visitor_tips, nearby_places,
  address_en, address_zh, audio_guide_count, iap_product_id, display_order, is_published
) VALUES ('nanjing_1865_creative_park',
  'nanjing',
  'Chenguang 1865 Science and Technology Creative Industry Park',
  '晨光1865科技创意产业园',
  'sight',
  'attractions/nanjing_1865_creative_park.png',
  'Chenguang 1865 Science and Technology Creative Industry Park is a creative industry park transformed from the former site of a century-old arsenal. Integrating science and technology, culture, tourism, and commerce, it is a model work of Nanjing''s modern industrial heritage protection and reuse.',
  'Chenguang 1865 Science and Technology Creative Industry Park is located at No. 388 Yingtian Street, Qinhuai District, Nanjing. It is a creative industry park transformed from the former site of the late Qing Dynasty "Jinling Machine Bureau." In 1865, Li Hongzhang founded the "Jinling Machine Bureau" outside Zhonghua Gate in Nanjing. This was one of the earliest modern arsenals in China, two years earlier than the Beiyang Machine Bureau founded by Li Hongzhang in Tianjin, and can be called the "cradle of China''s national industry."
...
Chenguang 1865 Science and Technology Creative Industry Park is open free of charge all day long, and is an ideal place to understand Nanjing''s modern industrial history and feel the creative cultural atmosphere.',
  'P2',
  '- **Public areas of the park:** Free admission
- **Some exhibition halls/experience projects:** May charge separately, subject to on-site announcements
- **Nanjing City Wall Museum:** Free admission (reservation required)
- **Tip:** Some enterprises, studios, restaurants, cafés, etc. within the park have separate consumption, subject to actual prices',
  NULL,
...
- **Tip:** The park is located near Zhonghua Gate. It is recommended to arrange visits to Zhonghuamen Castle, the Former Site Park of the Da Bao''en Temple, Laomendong, and other attractions on the same day',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕐", "label": "Duration", "value": "2–3 hours"}, {"icon": "🕘", "label": "Opening Hours", "value": "10:00–22:00"}, {"icon": "🚇", "label": "Metro", "value": "Metro Line 1, Zhonghuamen Station"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'No. 388 Yingtian Street, Qinhuai District, Nanjing, Jiangsu Province',
  '江苏省南京市秦淮区应天大街388号',
  0,
  'com.chinago.travel.attraction.nanjing_1865_creative_park',
  10,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
...
- **Tip:** Shijiu Lake is suitable for self-driving or taking Metro Line S9. It is recommended to plan the transportation route in advance',
  NULL,
...
- **Tip:** Shijiu Lake is far from downtown Nanjing (about 60—80 kilometers). It is recommended to reserve sufficient time; it is windy by the lake and the sun exposure is strong. Please take windproof, warmth-keeping, and sun protection measures',
  '[{"icon": "🎫", "label": "Ticket", "value": "Free"}, {"icon": "🕐", "label": "Duration", "value": "3 hours"}, {"icon": "🚇", "label": "Metro", "value": "Metro:**"}]'::jsonb,
  '[]'::jsonb,
  '[]'::jsonb,
  'Shijiu Lake, Lishui District, Nanjing, Jiangsu Province (for specific viewing points, you can navigate to "Shijiu Lake Grand Bridge" or "Xiangyang Village, Shiqi Subdistrict, Lishui District")',
  '江苏省南京市溧水区石臼湖（具体观赏点可导航至"石臼湖特大桥"或"溧水区石湫街道向阳村"）',
  0,
  'com.chinago.travel.attraction.nanjing_shijiu_lake',
  11,
  TRUE) ON CONFLICT (id) DO UPDATE SET
  city_id = EXCLUDED.city_id, name = EXCLUDED.name, chinese_name = EXCLUDED.chinese_name,
  category = EXCLUDED.category, cover_image_path = EXCLUDED.cover_image_path,
