# suzhou 子景点 canonical 导入确认清单

生成时间：2026-07-11T06:15:47.014Z
源目录：`/Users/vesperal/Desktop/新子景点信息`
总条数：126
...
### 1. 面水轩
- 来源 md：`新子景点信息/沧浪亭/01.面水轩.md`
- 配对图片：`01.面水轩.jpg`
- sub_area id：`suzhou_canglang_pavilion_sa_01`
- sort_order：0
- **中文名**：面水轩
- **英文名**：Mianshui Pavilion (Water-Facing Pavilion)
- **正文（英文）**：

```
Mianshui Pavilion sits just north of the garden entrance and serves as the first architectural highlight visitors encounter. Facing the water on its northern side, it spans three bays with a stone terrace projecting into the pond, making it the premier spot for viewing the outer Fengxi stream and borrowed scenery. The name "Mianshui" aptly describes its defining feature of facing the water. The structure uses a flush gable roof with a low eave line, maintaining an intimate connection with the water. It stands as the garden's overture, embodying Canglang Pavilion's celebrated concept of water encircling the garden before one even enters.
```

### 2. 观鱼处
- 来源 md：`新子景点信息/沧浪亭/02.观鱼处.md`
- 配对图片：`02.观鱼处.jpg`
- sub_area id：`suzhou_canglang_pavilion_sa_02`
- sort_order：1
- **中文名**：观鱼处
- **英文名**：Guanyu Spot (Fish-Watching Spot)
- **正文（英文）**：

```
Guanyu Spot lies east of Mianshui Pavilion, consisting of a stone terrace and a small viewing area at the water's edge. The open water teems with koi, evoking the ancient tale of Zhuangzi watching fish at Hao River, reflecting the garden owner's philosophical pursuit of transcendence. The terrace is built with Lake Tai stones arranged in varied heights, with weeping willows and sweet flag planted along the shore, their reflections enhancing the serene atmosphere. Visitors gazing at the leisurely koi can share the Song literati's spiritual resonance with "the joy of fish," making this one of the most philosophically rich viewing spots in the garden.
```

### 3. 沧浪亭
- 来源 md：`新子景点信息/沧浪亭/03.沧浪亭.md`
- 配对图片：`03.沧浪亭.jpg`
- sub_area id：`suzhou_canglang_pavilion_sa_03`
- sort_order：2
- **中文名**：沧浪亭
- **英文名**：Canglang Pavilion
- **正文（英文）**：

```
Canglang Pavilion is the centerpiece of the entire garden, perched atop a stone-and-earth hill at the center, exemplifying the rare Suzhou layout of "water encircling the garden with the hill as its core." The square pavilion features a four-hipped roof with upturned eaves, radiating classical elegance. Its columns bear the famous couplet by late-Qing scholar Yu Yue: "The refreshing breeze and bright moon are beyond price; near waters and distant hills both stir the heart." The name derives from the Chu Ci verse about the Canglang waters, symbolizing the owner's aspiration to retire from worldly affairs and preserve his integrity. From within, visitors gaze south at the hill and ancient trees, and north at the pond beyond the walls—the zenith of the garden's borrowing-scenery philosophy.
```

### 4. 明道堂
- 来源 md：`新子景点信息/沧浪亭/04.明道堂.md`
- 配对图片：`04.明道堂.jpg`
- sub_area id：`suzhou_canglang_pavilion_sa_04`
- sort_order：3
- **中文名**：明道堂
- **英文名**：Mingdao Hall (Hall of Understanding the Way)
- **正文（英文）**：

```
Mingdao Hall stands south of Canglang Pavilion and is the largest hall in the garden, spanning three bays with a deep plan and a broad front terrace. The name "Mingdao" means "to understand the Way of the former sages," dating back to Su Shunqin's original Song-era garden and preserved through subsequent rebuilds. The interior exposes its timber frame with large, unpainted members, reflecting the austere architectural style of the Song dynasty. The spacious forecourt is planted with ancient magnolias and bamboo, creating an elegant ambiance. This was the venue where the owner gathered with literati for scholarly discourse and poetic exchange, embodying the intellectual spirit of Canglang Pavilion as a Song literati garden.
```

### 5. 看山楼
- 来源 md：`新子景点信息/沧浪亭/05.看山楼.md`
- 配对图片：`05.看山楼.jpg`
- sub_area id：`suzhou_canglang_pavilion_sa_05`
- sort_order：4
- **中文名**：看山楼
- **英文名**：Kanshan Tower (Mountain-Viewing Tower)
- **正文（英文）**：

```
Kanshan Tower stands on a stone terrace atop the hill at the garden's southern end, a two-story pavilion with a flush-gable roof, marking the highest point in Canglang Pavilion. Its name "Kanshan" means "viewing mountains," as ascending it reveals vistas of Tianping, Lingyan, and Lion hills to the southwest. The tower masterfully employs the "distant borrowing" technique, drawing mountains beyond the garden walls into the visual composition, creating a sense of infinite space within finite bounds. The lower level is built on a yellow-stone base, while the upper timber story spreads its eaves gracefully. From the windows, visitors see bamboo and banana leaves nearby and blue mountain silhouettes afar, capturing the idyllic serenity celebrated by Song literati.
```

### 6. 翠玲珑
- 来源 md：`新子景点信息/沧浪亭/06.翠玲珑.md`
- 配对图片：`06.翠玲珑.jpg`
- sub_area id：`suzhou_canglang_pavilion_sa_06`
- sort_order：5
- **中文名**：翠玲珑
- **英文名**：Cui Linglong (Emerald Chamber)
- **正文（英文）**：

```
Cui Linglong is a small study tucked in a bamboo grove west of Kanshan Tower. Spanning merely one and a half bays, it is surrounded by tall bamboo on three sides, with sunlight filtering through the leaves to cast dappled shadows, creating an atmosphere of profound seclusion. The poetic name combines "cui" (emerald green bamboo) and "linglong" (exquisite and translucent). This was Su Shunqin's reading chamber, where he depicted scenes of studying amid bamboo in his "Record of Canglang Pavilion." A winding path before the chamber is dotted with Lake Tai stones, their forms interplaying with bamboo shadows. Removed from the main tourist route, the spot is exceptionally tranquil, offering an ideal place to experience the reclusive life of a Song literati and the garden's technique of suggesting grandeur through intimacy.
```

### 7. 五百名贤祠
- 来源 md：`新子景点信息/沧浪亭/07.五百名贤祠.md`
- 配对图片：`07.五百名贤祠.jpg`
- sub_area id：`suzhou_canglang_pavilion_sa_07`
- sort_order：6
- **中文名**：五百名贤祠
- **英文名**：Five Hundred Sages Shrine
- **正文（英文）**：

```
The Five Hundred Sages Shrine, located in the northwest of Canglang Pavilion, was established in the seventh year of the Daoguang reign (1827) by Tao Zhu, then Governor of Jiangsu. Its walls are inlaid with stone-carved half-length portraits of 594 Suzhou worthies spanning over two thousand years, from Ji Zha of the Spring and Autumn period to Lin Zexu of the Qing dynasty, covering politics, literature, art, and science. Each portrait is accompanied by a name and brief inscription, executed with succinct yet expressive carving. The shrine is not merely a memorial but a stone-carved chronicle of Suzhou's cultural heritage, embodying the city's reputation for producing exceptional talent. The architecture is austere and dignified, with grey brick and tile complementing the solemnity of the portraits.
```

### 8. 御碑亭
- 来源 md：`新子景点信息/沧浪亭/08.御碑亭.md`
- 配对图片：`08.御碑亭.jpg`
- sub_area id：`suzhou_canglang_pavilion_sa_08`
- sort_order：7
- **中文名**：御碑亭
- **英文名**：Imperial Stele Pavilion
- **正文（英文）**：

```
The Imperial Stele Pavilion is located in the west-central area of Canglang Pavilion, a small pavilion built specifically to shelter a stele inscribed by Emperor Kangxi of the Qing dynasty. The stele bears Kangxi's own calligraphy, composed during his southern inspection tour, praising the scenery of Canglang Pavilion and the virtue of Su Shunqin. The stele is carved from bluestone with a dragon-crested top and a bixi (mythical tortoise) base, exhibiting typical Qing imperial stele characteristics. The pavilion is square with a pyramidal roof and four stone columns, open on all sides for viewing the stele. It holds significant historical and cultural value, demonstrating the garden's sustained importance from the Song to the Qing, and represents a rare surviving example of imperial stele within Suzhou gardens.
```

### 9. 藕花水榭
- 来源 md：`新子景点信息/沧浪亭/09.藕花水榭.md`
- 配对图片：`09.藕花水榭.jpg`
- sub_area id：`suzhou_canglang_pavilion_sa_09`
- sort_order：8
- **中文名**：藕花水榭
- **英文名**：Ouhua Water Pavilion (Lotus Water Pavilion)
- **正文（英文）**：

```
Ouhua Water Pavilion sits at the northern water's edge of Canglang Pavilion, a classical waterside structure half-suspended over the pond. It is built facing the water, with the lower portion supported on stone columns projecting over the surface, and an upper timber structure with a flush-gable roof, open on all sides for panoramic water views. The name "Ouhua" refers to lotus flowers, which were historically planted here in abundance; in midsummer the scene of boundless green lotus leaves and crimson blooms is particularly enchanting. Beyond lotus viewing, the pavilion offers one of the best vantage points for the outer pond and borrowed scenery to the north. Even in autumn and winter, the withered lotus leaves on the water convey a melancholy beauty, embodying the Suzhou garden aesthetic of beauty in all four seasons.
```
...
### 19. 门厅
- 来源 md：`新子景点信息/耦园/01.门厅.md`
- 配对图片：`01.门厅.jpg`
- sub_area id：`suzhou_ou_garden_sa_01`
- sort_order：0
- **中文名**：门厅
- **英文名**：Entrance Hall
- **正文（英文）**：
...
```
The Wisteria Garden occupies the transitional zone between the new wing and the Loyal King's Mansion, the museum's most poetic small garden space. The wisteria vines originate from centuries-old stock inside the Loyal King's Mansion; I.M. Pei personally grafted them here, enabling this time-spanning life to continue blossoming in the new wing. Each April, wisteria cascades like a waterfall, purple petals swaying in the breeze against white walls and gray tiles in stunning color contrast. Stone paths wind beneath the canopy, light dappling through leaves — a moment's pause here reveals Pei's deeper design philosophy using plants as living links: new and old are not severed but share the same roots.
```

### 57. 茶室
- 来源 md：`新子景点信息/苏州博物馆/09.茶室.md`
- 配对图片：`09.茶室.jpg`
- sub_area id：`suzhou_museum_sa_09`
- sort_order：8
- **中文名**：茶室
- **英文名**：Tea Room
- **正文（英文）**：
...
```
The Tea Room sits on the west side of the new wing, with expansive floor-to-ceiling glass directly facing the Main Courtyard's slice-rock rockery and water feature — the museum's most restorative retreat. Suzhou Biluochun is the signature brew, accompanied by local tea snacks, inviting visitors to slow their pace with a cup of clear tea after viewing exhibitions. The design extends Pei's minimalist aesthetic: gray-white tones with wooden furniture, landscape paintings beyond the glass, tea mist within, merging into a distinctive Zen atmosphere. Whether for a leisurely afternoon sit or a brief inter-exhibition pause, the Tea Room transforms the museum visit into a sensory pleasure.
```

### 58. 太平天国忠王府
- 来源 md：`新子景点信息/苏州博物馆/10.太平天国忠王府.md`
- 配对图片：`10.太平天国忠王府.jpg`
- sub_area id：`suzhou_museum_sa_10`
- sort_order：9
- **中文名**：太平天国忠王府
- **英文名**：Taiping Heavenly Kingdom Loyal King Mansion
- **正文（英文）**：

```
The Loyal King's Mansion is a core component of Suzhou Museum, originally the Suzhou residence of the Taiping Heavenly Kingdom's Loyal King Li Xiucheng, built around 1860. It is one of the best-preserved Taiping historical buildings in China, where classical Suzhou palace layout coexists with distinctive Taiping decorative elements — dragon carvings, painted murals, and Taiping inscriptions forming unique layers of historical information. The indoor classical stage inside is a rare large-scale theater in Jiangnan, its caisson ceiling carved with breathtaking finesse. Connected to Pei's new wing, stepping from the classical halls into the modern space crosses a century in a single stride, giving the tension between history and contemporary its most vivid expression.
```
...
### 59. 有穀堂
- 来源 md：`新子景点信息/苏州环秀山庄/01.有穀堂.md`
- 配对图片：`01.有穀堂.jpg`
- sub_area id：`suzhou_huanxiu_mountain_villa_sa_01`
- sort_order：0
- **中文名**：有穀堂
- **英文名**：Yougu Hall (Hall of Abundant Grain)
- **正文（英文）**：

```
Yougu Hall sits at the front of the entrance axis of Huanxiu Mountain Villa, serving as the first hall visitors encounter, fulfilling both welcoming and ceremonial functions. The name "Yougu" derives from the Analerta, where "gu" carries the dual meaning of virtue and blessing, symbolizing abundance in goodness and fortune. The hall spans three bays with a flush gable roof,通透 on all sides—facing the entrance courtyard to the south and the main pond to the north—serving as the transitional space connecting the front and rear garden areas. The timber frame is finely crafted, the furnishings simple, with a plaque suspended at the center. Though modest in scale, its clear axial relationship creates a dialogue with the main rockery; gazing north from within, Ge Yuliang's masterpiece comes into full view, establishing the classic "hall facing mountain" layout that defines the garden's spatial structure.
```

### 60. 环秀山庄（四面厅）
- 来源 md：`新子景点信息/苏州环秀山庄/02.环秀山庄（四面厅）.md`
- 配对图片：`02.环秀山庄（四面厅）.jpg`
- sub_area id：`suzhou_huanxiu_mountain_villa_sa_02`
- sort_order：1
- **中文名**：环秀山庄（四面厅）
- **英文名**：Huanxiu Mountain Villa (Four-Side Hall)
- **正文（英文）**：

```
The Four-Side Hall is situated north of the main pond and serves as the garden's central viewing structure. Spanning five bays with corridors on all four sides and continuous windows on each elevation, it earns its name by offering views in every direction. Facing the pond with Ge Yuliang's main rockery directly across the water, it is the premier spot for viewing the rockery in its entirety. Though the largest building in the garden, its well-proportioned dimensions maintain an intimate human scale without feeling oppressive. The hall originally bore the plaque "Huanxiu Mountain Villa," from which the garden takes its name. As the visual focal point and spatial hub, visitors can gaze north at the majestic main peak and deep caves, east at the side galleries, west at the towering Hanyun Pavilion, and south at the pond's reflections, embodying the Suzhou principle of a hall as the eye of the garden with scenery on all sides.
```

### 61. 戈裕良假山
- 来源 md：`新子景点信息/苏州环秀山庄/03.戈裕良假山.md`
- 配对图片：`03.戈裕良假山.jpg`
- sub_area id：`suzhou_huanxiu_mountain_villa_sa_03`
- sort_order：2
- **中文名**：戈裕良假山
- **英文名**：Ge Yuliang Rockery
- **正文（英文）**：

```
The Ge Yuliang Rockery is the soul of Huanxiu Mountain Villa, constructed by the Qing dynasty master Ge Yuliang during the Jiaqing reign. Covering less than half a mu with a main peak exceeding seven meters in height, it creates a majestic landscape of undulating ridges, deep caves, and intersecting ravines, hailed by garden scholar Chen Congzhou as "the crown of Chinese classical garden rockeries." Ge pioneered the "grand axe-cut texture" technique, stacking Lake Tai stones into precipitous cliffs, flying stone bridges, and hidden grottoes with running water beneath. The rockery is fully explorable: stone paths spiral to the summit for panoramic views, while tunnels offer an immersive journey through shifting spatial experiences. It represents the supreme realization of the classical ideal of a garden that is both "tourable and inhabitable," possessing unparalleled artistic and historical value.
```

### 62. 涵云阁
- 来源 md：`新子景点信息/苏州环秀山庄/04.涵云阁.md`
- 配对图片：`04.涵云阁.jpg`
- sub_area id：`suzhou_huanxiu_mountain_villa_sa_04`
- sort_order：3
- **中文名**：涵云阁
- **英文名**：Hanyun Pavilion (Cloud-Encompassing Pavilion)
- **正文（英文）**：

```
Hanyun Pavilion stands on the western side of Huanxiu Mountain Villa, a two-story tower built flush against the garden wall. The name "Hanyun" means "encompassing clouds," alluding to its lofty presence. The structure is diminutive yet precisely proportioned, with a masonry ground floor and a timber upper story featuring latticed windows on all sides. As the highest point in the garden, the upper floor offers a bird's-eye view of the Ge Yuliang Rockery, complementing the ground-level perspective from the Four-Side Hall. Though compact inside, the windows reveal the rockery appearing as a real mountain nearby, while the distant city skyline is borrowed as scenery beyond, showcasing the garden's masterful manipulation of scale. The pavilion is also the optimal vantage for observing the rockery's layered composition and stacking technique from the side.
```

### 63. 边楼与边廊
- 来源 md：`新子景点信息/苏州环秀山庄/05.边楼与边廊.md`
- 配对图片：`05.边楼与边廊.jpg`
- sub_area id：`suzhou_huanxiu_mountain_villa_sa_05`
- sort_order：4
- **中文名**：边楼与边廊
- **英文名**：Side Building and Corridor
- **正文（英文）**：

```
The Side Building and Corridor run along the eastern wall of Huanxiu Mountain Villa, serving as the connective tissue linking the garden's various zones. The Side Building is two stories—a corridor below and rooms above—joined with the corridor in a rhythmic high-low sequence. The corridor winds and turns, sometimes hugging the wall, sometimes opening to views, adjusting its path in response to terrain and landscape, embodying the Suzhou principle of "corridors guiding visitors, scenery shifting with every step." Lattice windows and moon gates along the corridor frame views of the rockery, pond, and plantings like a series of landscape paintings unrolled in sequence. The upper floor also provides an elevated vantage for observing the eastern face of the rockery, combining circulation and viewing functions.
```

### 64. 问泉亭
- 来源 md：`新子景点信息/苏州环秀山庄/06.问泉亭.md`
- 配对图片：`06.问泉亭.jpg`
- sub_area id：`suzhou_huanxiu_mountain_villa_sa_06`
- sort_order：5
- **中文名**：问泉亭
- **英文名**：Wenquan Pavilion (Spring-Inquiring Pavilion)
- **正文（英文）**：

```
Wenquan Pavilion stands near the Feixue Spring ruins within Huanxiu Mountain Villa, a small square pavilion built specifically for viewing the spring and its surrounding rock-and-water composition. The name "Wenquan" (Inquiring After the Spring) carries refined literati sensibility, personifying the spring with a sense of seeking and inquiry, reflecting the garden owner's cherishing of and intimacy with the natural water source. The pavilion features a four-sided pyramidal roof on four columns, light and open, blending seamlessly with the adjacent rockery and stone paths. From within, visitors can observe the spring's outlet and the interplay of water and stone up close, listening to the murmuring flow and appreciating the poetic notion of inquiring how the spring stays so clear. Surrounded by Lake Tai stones and ancient trees, it is one of the most serene rest stops in the garden.
```

### 65. 补秋舫
- 来源 md：`新子景点信息/苏州环秀山庄/07.补秋舫.md`
- 配对图片：`07.补秋舫.jpg`
- sub_area id：`suzhou_huanxiu_mountain_villa_sa_07`
- sort_order：6
- **中文名**：补秋舫
- **英文名**：Buqiu Studio (Autumn-Compensating Studio)
- **正文（英文）**：

```
Buqiu Studio is located east of the main rockery within Huanxiu Mountain Villa, a land-boat structure representing a common Suzhou garden archetype. The front mimics a prow, the rear corridor suggests a stern, and the central cabin features latticed windows on both sides, the whole resembling a painted pleasure boat moored among rocks. The name "Buqiu" (Compensating for Autumn) implies that this spot makes up for any insufficiency in autumn scenery, reflecting the owner's fondness for autumn colors. The studio faces the eastern foot of the rockery, where autumn maples blaze against the yellow-stone rocks in a riot of color, fulfilling the "buqiu" aspiration. The land-boat form satisfies viewing needs while the nautical imagery evokes water and reverie, bringing the delight of boating to a waterless setting, exemplifying the Suzhou technique of substituting meaning for scenery and interweaving the real and the imagined.
```

### 66. 半潭秋水一房山亭
- 来源 md：`新子景点信息/苏州环秀山庄/08.半潭秋水一房山亭.md`
- 配对图片：`08.半潭秋水一房山亭.jpg`
- sub_area id：`suzhou_huanxiu_mountain_villa_sa_08`
- sort_order：7
- **中文名**：半潭秋水一房山亭
- **英文名**：Bantan Qiushui Yifangshan Pavilion (Half-Pond Autumn Water and One-Room Mountain Pavilion)
- **正文（英文）**：

```
Bantan Qiushui Yifangshan Pavilion crowns the summit of the main rockery, the highest viewing point in Huanxiu Mountain Villa. The highly poetic name derives from Song dynasty verse: "half a pond of autumn water" refers to the pool seen below, and "one room of mountain" describes the rocks surrounding the pavilion, seamlessly fusing location and vista. The hexagonal pavilion is diminutive, accommodating only a few, perched on the main peak with eaves like wings ready to take flight. Reaching it requires spiraling up steep, narrow stone paths through deep grottoes, culminating in a sudden panoramic revelation. From within, the entire garden—pond, rockery, and architecture—unfolds below, with the half-pond at its foot and rocks filling the view, perfectly matching its name. It is the ultimate vantage for experiencing Ge Yuliang's art of "vast mountains in a miniature space" and the most poetically evocative spot in the garden.
```

### 67. 飞雪泉遗址
- 来源 md：`新子景点信息/苏州环秀山庄/09.飞雪泉遗址.md`
- 配对图片：`09.飞雪泉遗址.jpg`
- sub_area id：`suzhou_huanxiu_mountain_villa_sa_09`
- sort_order：8
- **中文名**：飞雪泉遗址
- **英文名**：Feixue Spring Ruins
- **正文（英文）**：

```
The Feixue Spring Ruins lie at the southwestern foot of the rockery in Huanxiu Mountain Villa, marking the site of the garden's most important historical water source. Named for its spray resembling flying snow, the spring once yielded clear, cold water that fed the streams running through the rockery, contributing to the villa's name. When Ge Yuliang constructed the rockery during the Qing dynasty, he channeled this spring to the summit, creating a cascade that tumbled through the rocks, animating the rockery with the dynamic interplay of mountain and water. Though the spring has since run dry, the surrounding rockwork, pool walls, and stone channels remain intact, allowing visitors to imagine the former spectacle of cascading water. The ruins, with their craggy Lake Tai stones, ancient vines, and mottled moss, exude a beauty of desolate antiquity—a place to contemplate the passage of time and the garden's historical transformation.
```

## 同里古镇（suzhou_tongli_ancient_town）

### 68. 退思园
- 来源 md：`新子景点信息/同里古镇/01.退思园.md`
- 配对图片：`01.退思园.jpg`
- sub_area id：`suzhou_tongli_ancient_town_sa_01`
- sort_order：0
- **中文名**：退思园
- **英文名**：Tuisi Garden (Retreat & Reflection Garden)
- **正文（英文）**：

```
Built in the Guangxu era of the Qing dynasty, the garden was constructed by Ren Lansheng after his dismissal from office, named after the Zuo Zhuan phrase "Advance to serve with loyalty, retreat to reflect and mend faults." Though only 9.8 mu in area, its masterly layout creates infinite poetic resonance within limited space — pavilions, towers, pools, rockeries, flowers, trees, corridors, and bridges. All buildings are constructed flush against the water, forming a "water-hugging" architectural ensemble including Spring View Tower, Cool Arrowroot Rain Pavilion, and Osmanthus Hall. The mirror-like water reflects pavilions, merging reality and illusion. As a UNESCO World Heritage site and Tongli's core attraction, its "seeing the vast in the small" design philosophy is hailed as the paradigm of Jiangnan gardens.
```

### 69. 珍珠塔
- 来源 md：`新子景点信息/同里古镇/02.珍珠塔.md`
- 配对图片：`02.珍珠塔.jpg`
- sub_area id：`suzhou_tongli_ancient_town_sa_02`
- sort_order：1
- **中文名**：珍珠塔
- **英文名**：Pearl Tower
- **正文（英文）**：
...
```
The entrance to Yipu Garden is deliberately inconspicuous, tucked away at the far end of Wenya Lane — a narrow, winding alleyway in Suzhou's old city. This "hidden within the city" approach is characteristic of Suzhou's literati gardens, which favor understatement over grandeur. The gate itself is a traditional stone-framed doorway with grey brick and dark tiles, virtually indistinguishable from neighboring residences. First-time visitors can easily walk past without realizing that a UNESCO World Heritage garden lies within. Stepping through the gate, the noise of the city falls away instantly, replaced by a serene courtyard — a spatial transition from bustle to tranquility that is Yipu's first gift to every guest.
```

### 99. 世纶堂
- 来源 md：`新子景点信息/艺圃/02.世纶堂.md`
- 配对图片：`02.世纶堂.jpg`
- sub_area id：`suzhou_yi_garden_sa_02`
- sort_order：1
- **中文名**：世纶堂
- **英文名**：Shilun Hall
- **正文（英文）**：
...
### 106. 芹庐
- 来源 md：`新子景点信息/艺圃/09.芹庐.md`
- 配对图片：`09.芹庐.jpg`
- sub_area id：`suzhou_yi_garden_sa_09`
- sort_order：8
- **中文名**：芹庐
- **英文名**：Qinlu Hermitage
- **正文（英文）**：
