-- Generated from selected markdown paths
INSERT INTO sub_areas (
  id, attraction_id, name_en, name_zh, body, sort_order, is_active
) VALUES (
  'chengdu_museum_sa_01', 'chengdu_museum', '', '中国历代书法馆', '', 0, TRUE
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_02', 'chengdu_museum', '', '中国历代玺印馆', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_03', 'chengdu_museum', '', '中国历代绘画馆', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_04', 'chengdu_museum', '', '中国历代钱币馆', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_05', 'chengdu_museum', '', '中国古代玉器馆', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_06', 'chengdu_museum', '', '中国古代陶瓷馆', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_07', 'chengdu_museum', '', '中国古代雕塑馆', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_08', 'chengdu_museum', '', '中国古代青铜馆', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_09', 'chengdu_museum', '', '中国明清家具馆', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_10', 'chengdu_museum', '', '解说词-中国少数民族工艺馆', '', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_11', 'chengdu_museum', '', '三楼·丹楼生晚辉——明清时期的成都', '<p>"Red towers glow in the evening" is taken from the poem of Yang Shen, a Ming Dynasty scholar from Sichuan. The gallery is located on the 3rd floor of Chengdu Museum.</p>', 10, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_12', 'chengdu_museum', '', '三楼·喧然名都会——隋唐五代宋元时期的成都', '<p>"A bustling famous metropolis" is taken from the Tang Dynasty poet Du Fu''s poem "Chengdu Fu," with the line "A bustling famous metropolis, with flutes and sheng pipes alternating."</p>', 11, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_14', 'chengdu_museum', '', '二楼·西蜀称天府——两汉魏晋南北朝时期的成都', '<p>The "Western Shu Known as Land of Abundance" gallery is located on the 2nd floor of Chengdu Museum, as the second part of the "Flowers Weigh Down Brocade City — Chengdu Historical and Cultural Exhibition (Ancient Period)."</p>', 13, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_15', 'chengdu_museum', '', '五楼·偶戏大千——中国木偶展', '<p>"Puppet Theater of the Great Thousand — Chinese Puppet Exhibition" is located on the 5th floor of Chengdu Museum, adjacent to the "Shadow Dance of All Phenomena — Chinese Shadow Puppetry Exhibition."</p>', 14, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_17', 'chengdu_museum', '', '四楼·花重锦官城——成都历史文化陈列（民俗篇）', '<p>"Flowers Weigh Down Brocade City — Chengdu Historical and Cultural Exhibition (Folk Customs Section)" is located on the 4th floor of Chengdu Museum.</p>', 16, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_18', 'chengdu_museum', '', '四楼·花重锦官城——成都历史文化陈列（近世篇）', '<p>"Flowers Weigh Down Brocade City — Chengdu Historical and Cultural Exhibition (Modern Period)" is located on the 4th floor of Chengdu Museum, focusing on Chengdu''s modern history from the mid-19th century to the mid-20th century.</p>', 17, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chengdu_museum_sa_20', 'chengdu_museum', '', '负一楼·人与自然——贝林捐赠展', '<p>"Man and Nature — Behring Donation Exhibition" is located on the basement level 1 of Chengdu Museum, and is the first nature-themed exhibition since the museum''s establishment.</p>', 19, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'the_bund_shanghai_sa_03', 'the_bund_shanghai', '', '亚细亚大楼（外滩一号）', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'the_bund_shanghai_sa_04', 'the_bund_shanghai', '', '十六铺码头', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'the_bund_shanghai_sa_05', 'the_bund_shanghai', '', '原汇丰银行大楼', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'the_bund_shanghai_sa_07', 'the_bund_shanghai', '', '外滩十八号', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'shanghai_disney_resort_sa_01', 'shanghai_disney_resort', '', '奇想花园', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'shanghai_disney_resort_sa_02', 'shanghai_disney_resort', '', '宝藏湾', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'shanghai_disney_resort_sa_03', 'shanghai_disney_resort', '', '探险岛', '<p>cm）。另有"雷鸣山漂流"（室外激流漂流，身高≥107cm）、"古迹探寻营"（绳索挑战道等户外探索路线）等冒险项目。园区设计灵感来自太平洋岛屿与南美丛林的混合文明，弥漫着烟雾与水雾效果，是乐园最具沉浸感的主题区之一。</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'shanghai_disney_resort_sa_04', 'shanghai_disney_resort', '', '明日世界', '<p>cm），游客跨骑发光摩托车在光影隧道中疾驰，是全球迪士尼乐园中最刺激的过山车之一。其他项目包括"巴斯光年星际营救"（室内互动射击）、"喷气背包飞行器"（室外旋转飞行，身高≥122cm）、"创界：雪佛兰数字挑战"（互动体验未来驾驶）等。园区还定期举办"复仇者联盟培训行动"演出与"E 空间聚乐部"电子音乐派对。</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'shanghai_disney_resort_sa_05', 'shanghai_disney_resort', '', '星愿公园', '<p>When You Wish Upon a Star）为命名灵感，湖心有一座名为"星愿"的巨型灯光装置，夜晚点亮后倒映湖面，是度假区标志性夜景之一。公园还设有自行车租赁点（双人/四人自行车）、皮划艇体验区与季节性花展，是亲子家庭与跑步爱好者在乐园外消磨时光的理想选择。</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'shanghai_disney_resort_sa_06', 'shanghai_disney_resort', '', '梦幻世界', '<p>cm）、"小飞侠天空奇遇"（室内悬挂飞行）、"小熊维尼历险记"（室内乘船）、"晶彩奇航"（室外水上项目）、"爱丽丝梦游仙境迷宫"（室外互动迷宫）等。城堡内还设有"漫游童话时光"白雪公主互动体验与"冰雪奇缘：欢唱盛会"演出（约 20 分钟）。</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'shanghai_disney_resort_sa_07', 'shanghai_disney_resort', '', '玩具总动员乐园', '<p>U 型轨道赛车，身高≥120cm）、"弹簧狗团团转"（室外旋转追逐）、"胡迪牛仔嘉年华"（西部马车 ride，身高≥81cm）。园区整体色彩鲜艳、节奏轻松，是亲子家庭与低龄儿童最友好的主题区。</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'shanghai_disney_resort_sa_08', 'shanghai_disney_resort', '', '疯狂动物城', '<p>Zootopia）的城市场景——不同体型的动物区域、列车系统、霓虹招牌、市政厅。标志性游乐项目"疯狂动物城：热力追踪"是全园最新的高科技沉浸式乘骑体验。园区内随处可见尼克、朱迪、闪电等电影角色的互动装置与拍照点。2023 年 3 月 10 日，小熊猫"美美"在此全球首发亮相。2024 年 11 月，该园区荣获全球主题娱乐协会（TEA）2025 年度"主题乐园园区杰出成就奖"。</p>', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'shanghai_disney_resort_sa_09', 'shanghai_disney_resort', '', '米奇大街', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'shanghai_disney_resort_sa_10', 'shanghai_disney_resort', '', '迪士尼小镇', '<p>The BOATHOUSE、元素 Table）、迪士尼官方商店（世界最大迪士尼旗舰店之一）、大隐书局、乐高品牌旗舰店等零售店铺。小镇内的"华特迪士尼大剧院"上演百老汇音乐剧《狮子王》中文版（需单独购票）。小镇还定期举办季节性集市、户外演出与灯光装置展，是游客在乐园外消磨半天的热门去处。</p>', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market_sa_01', 'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market', '', '一楼-Kate&Kevin定制工坊', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market_sa_02', 'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market', '', '一楼-成衣与皮具区', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market_sa_03', 'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market', '', '三楼-传统面料零售区', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market_sa_04', 'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market', '', '三楼-旗袍与中式服装区', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market_sa_05', 'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market', '', '二楼-西装定制核心区', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market_sa_06', 'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market', '', '二楼-进口面料坊', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market_sa_07', 'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market', '', '四楼-羊绒与杂项区', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market_sa_08', 'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market', '', '市场入口大厅', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market_sa_09', 'south_bund_fabric_market_commonly_known_as_dongjiadu_fabric_market', '', '黄浦邮政国际寄送服务台', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'xujiahui_source_scenic_area_sa_02', 'xujiahui_source_scenic_area', '', '上海电影博物馆', '<p>Detailed Description: Located at No. 595 Caoxi North Road on the original site of Shanghai Film Studio, the Shanghai Film Museum opened on June 16, 2013, the opening day of the Shanghai International Film Festival. It is one of the largest film-themed museums in China. The museum is divided into four themed halls: "Memory of Light and Shadow" traces Shanghai''s 100-year cinema history since the late 19th century; "Film Factory" reveals the production process; "River of Light" walks visitors through milestones of Chinese cinema; "Centennial Brilliance" pays tribute to Shanghai filmmakers. Special exhibitions on the first floor feature international masters. The collection includes more than 15,000 film artifacts and documents, including original posters and props from classics like "Song of the Fishermen" and "Children of Troubled Times."</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'zhujiajiao_ancient_town_sa_01', 'zhujiajiao_ancient_town', '', '放生桥', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'zhujiajiao_ancient_town_sa_02', 'zhujiajiao_ancient_town', '', '北大街', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'zhujiajiao_ancient_town_sa_03', 'zhujiajiao_ancient_town', '', '涵大隆酱园', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'zhujiajiao_ancient_town_sa_04', 'zhujiajiao_ancient_town', '', '泰安桥', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'zhujiajiao_ancient_town_sa_05', 'zhujiajiao_ancient_town', '', '圆津禅院', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'zhujiajiao_ancient_town_sa_06', 'zhujiajiao_ancient_town', '', '廊桥', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'zhujiajiao_ancient_town_sa_07', 'zhujiajiao_ancient_town', '', '城隍庙', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'zhujiajiao_ancient_town_sa_08', 'zhujiajiao_ancient_town', '', '课植园', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'zhujiajiao_ancient_town_sa_09', 'zhujiajiao_ancient_town', '', '大清邮局', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'wukang_road_sa_01', 'wukang_road', '', '武康路 · 周璇旧居', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'wukang_road_sa_02', 'wukang_road', '', '武康路 · 宋庆龄故居', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'wukang_road_sa_03', 'wukang_road', '', '武康路 · 密丹公寓', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'wukang_road_sa_04', 'wukang_road', '', '武康路 · 巴金故居', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'wukang_road_sa_05', 'wukang_road', '', '武康路 · 意大利总领事馆旧址', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'wukang_road_sa_06', 'wukang_road', '', '武康路 · 武康大楼（诺曼底公寓）', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'wukang_road_sa_07', 'wukang_road', '', '武康路 · 武康庭', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'wukang_road_sa_08', 'wukang_road', '', '武康路 · 罗密欧阳台（德利那齐宅）', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'wukang_road_sa_09', 'wukang_road', '', '武康路 · 黄兴故居老房子艺术中心', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'tianzifang_sa_01', 'tianzifang', '', '田子坊 · 248 弄弄堂', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'tianzifang_sa_02', 'tianzifang', '', '田子坊 · 274 弄艺术长廊', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'tianzifang_sa_03', 'tianzifang', '', '田子坊 · 守白艺术中心', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'tianzifang_sa_04', 'tianzifang', '', '田子坊 · 气味图书馆', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'tianzifang_sa_05', 'tianzifang', '', '田子坊 · 泰康路主入口', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'tianzifang_sa_06', 'tianzifang', '', '田子坊 · 画家楼天台', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'tianzifang_sa_07', 'tianzifang', '', '田子坊 · 石库门里弄建筑群', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'tianzifang_sa_08', 'tianzifang', '', '田子坊 · 金粉世家', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'tianzifang_sa_09', 'tianzifang', '', '田子坊 · 陈逸飞工作室旧址', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'suzhou_creek_twelve_nations_colors_sa_03', 'suzhou_creek_twelve_nations_colors', '', '半马苏河公园（钴蓝色）', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'yu_garden_sa_01', 'yu_garden', '', '三穗堂', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'yu_garden_sa_02', 'yu_garden', '', '得月楼', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'yu_garden_sa_03', 'yu_garden', '', '内园', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'yu_garden_sa_04', 'yu_garden', '', '仰山堂卷雨楼', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'yu_garden_sa_05', 'yu_garden', '', '大假山', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'yu_garden_sa_06', 'yu_garden', '', '萃秀堂', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'yu_garden_sa_07', 'yu_garden', '', '万花楼', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'yu_garden_sa_08', 'yu_garden', '', '点春堂', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'yu_garden_sa_09', 'yu_garden', '', '玉玲珑', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'yu_garden_sa_10', 'yu_garden', '', '玉华堂', '', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'yu_garden_sa_11', 'yu_garden', '', '会景楼', '', 10, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'lujiazui_financial_district_sa_01', 'lujiazui_financial_district', '', '上海中心大厦（上海之巅）', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'lujiazui_financial_district_sa_02', 'lujiazui_financial_district', '', '上海海洋水族馆', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'lujiazui_financial_district_sa_03', 'lujiazui_financial_district', '', '上海环球金融中心', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'lujiazui_financial_district_sa_04', 'lujiazui_financial_district', '', '世纪大道', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'lujiazui_financial_district_sa_05', 'lujiazui_financial_district', '', '东方明珠广播电视塔', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'lujiazui_financial_district_sa_06', 'lujiazui_financial_district', '', '吴昌硕纪念馆', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'lujiazui_financial_district_sa_07', 'lujiazui_financial_district', '', '浦东滨江大道', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'lujiazui_financial_district_sa_08', 'lujiazui_financial_district', '', '金茂大厦', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'lujiazui_financial_district_sa_09', 'lujiazui_financial_district', '', '陆家嘴中心绿地', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_silk_museum_sa_01', 'hangzhou_silk_museum', '', '中国丝绸博物馆入口', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_silk_museum_sa_02', 'hangzhou_silk_museum', '', '户外园林与茶园', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_silk_museum_sa_03', 'hangzhou_silk_museum', '', '丝路馆：中国丝绸故事', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_silk_museum_sa_04', 'hangzhou_silk_museum', '', '蚕桑馆', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_silk_museum_sa_05', 'hangzhou_silk_museum', '', '织造馆', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_silk_museum_sa_06', 'hangzhou_silk_museum', '', '服饰馆：华美服饰', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_silk_museum_sa_07', 'hangzhou_silk_museum', '', '修复馆：纺织品文物修复', '<p>Description</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_silk_museum_sa_08', 'hangzhou_silk_museum', '', '锦绣廊', '<p>Description</p>', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_silk_museum_sa_09', 'hangzhou_silk_museum', '', '时装馆', '<p>Description</p>', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_silk_museum_sa_10', 'hangzhou_silk_museum', '', '晓风书屋与文创空间', '<p>Description</p>', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_grand_canal_sa_01', 'hangzhou_grand_canal', '', '武林门码头', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_grand_canal_sa_02', 'hangzhou_grand_canal', '', '运河广场', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_grand_canal_sa_03', 'hangzhou_grand_canal', '', '西湖文化广场', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_grand_canal_sa_04', 'hangzhou_grand_canal', '', '信义坊', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_grand_canal_sa_05', 'hangzhou_grand_canal', '', '富义仓', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_grand_canal_sa_06', 'hangzhou_grand_canal', '', '小河直街', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_grand_canal_sa_07', 'hangzhou_grand_canal', '', '小河公园', '<p>Description</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_grand_canal_sa_08', 'hangzhou_grand_canal', '', '桥西历史文化街区', '<p>Description</p>', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_grand_canal_sa_09', 'hangzhou_grand_canal', '', '中国京杭大运河博物馆', '<p>Description</p>', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_grand_canal_sa_10', 'hangzhou_grand_canal', '', '拱宸桥', '<p>Description</p>', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liuhe_pagoda_sa_01', 'hangzhou_liuhe_pagoda', '', '六和塔景区入口', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liuhe_pagoda_sa_02', 'hangzhou_liuhe_pagoda', '', '碑亭', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liuhe_pagoda_sa_03', 'hangzhou_liuhe_pagoda', '', '六和塔', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liuhe_pagoda_sa_04', 'hangzhou_liuhe_pagoda', '', '塔基与地宫', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liuhe_pagoda_sa_05', 'hangzhou_liuhe_pagoda', '', '塔身一至七层', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liuhe_pagoda_sa_06', 'hangzhou_liuhe_pagoda', '', '塔顶层观景台', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liuhe_pagoda_sa_07', 'hangzhou_liuhe_pagoda', '', '六和塔文化陈列馆', '<p>Description</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liuhe_pagoda_sa_08', 'hangzhou_liuhe_pagoda', '', '中华古塔博览苑', '<p>Description</p>', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liuhe_pagoda_sa_09', 'hangzhou_liuhe_pagoda', '', '钱塘江观景平台', '<p>Description</p>', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liuhe_pagoda_sa_10', 'hangzhou_liuhe_pagoda', '', '六合钟声', '<p>Description</p>', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_qiandao_lake_sa_01', 'hangzhou_qiandao_lake', '', '千岛湖中心湖区旅游码头', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_qiandao_lake_sa_02', 'hangzhou_qiandao_lake', '', '东南湖区黄山尖', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_qiandao_lake_sa_03', 'hangzhou_qiandao_lake', '', '梅峰岛', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_qiandao_lake_sa_04', 'hangzhou_qiandao_lake', '', '渔乐岛', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_qiandao_lake_sa_05', 'hangzhou_qiandao_lake', '', '龙山岛', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_qiandao_lake_sa_06', 'hangzhou_qiandao_lake', '', '海瑞祠', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_qiandao_lake_sa_07', 'hangzhou_qiandao_lake', '', '月光岛', '<p>Description</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_qiandao_lake_sa_08', 'hangzhou_qiandao_lake', '', '锁岛', '<p>Description</p>', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_qiandao_lake_sa_09', 'hangzhou_qiandao_lake', '', '状元桥', '<p>Description</p>', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_qiandao_lake_sa_10', 'hangzhou_qiandao_lake', '', '温馨岛', '<p>Description</p>', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xiaohe_street_sa_01', 'hangzhou_xiaohe_street', '', '小河直街历史文化街区入口', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xiaohe_street_sa_02', 'hangzhou_xiaohe_street', '', '小河直街夜景', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xiaohe_street_sa_03', 'hangzhou_xiaohe_street', '', '小河直街运河码头遗址', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xiaohe_street_sa_04', 'hangzhou_xiaohe_street', '', '小河直街老邮局', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xiaohe_street_sa_05', 'hangzhou_xiaohe_street', '', '小河直街手作工坊集群', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xiaohe_street_sa_06', 'hangzhou_xiaohe_street', '', '小河直街运河主题餐厅', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xiaohe_street_sa_07', 'hangzhou_xiaohe_street', '', '小河公园', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xiaohe_street_sa_08', 'hangzhou_xiaohe_street', '', '小河直街独立书店', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xiaohe_street_sa_09', 'hangzhou_xiaohe_street', '', '小河直街民宿集群', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xiaohe_street_sa_10', 'hangzhou_xiaohe_street', '', '小河直街古桥', '', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_gongchen_bridge_sa_01', 'hangzhou_gongchen_bridge', '', '运河广场', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_gongchen_bridge_sa_02', 'hangzhou_gongchen_bridge', '', '富义仓', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_gongchen_bridge_sa_03', 'hangzhou_gongchen_bridge', '', '拱宸桥', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_gongchen_bridge_sa_04', 'hangzhou_gongchen_bridge', '', '桥西历史文化街区', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_gongchen_bridge_sa_05', 'hangzhou_gongchen_bridge', '', '中国伞博物馆', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_gongchen_bridge_sa_06', 'hangzhou_gongchen_bridge', '', '中国刀剪剑博物馆', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_gongchen_bridge_sa_07', 'hangzhou_gongchen_bridge', '', '中国扇博物馆', '<p>Description</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_gongchen_bridge_sa_08', 'hangzhou_gongchen_bridge', '', '杭州工艺美术博物馆', '<p>Description</p>', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_gongchen_bridge_sa_09', 'hangzhou_gongchen_bridge', '', '张大仙庙', '<p>Description</p>', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_gongchen_bridge_sa_10', 'hangzhou_gongchen_bridge', '', '小河公园', '<p>Description</p>', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_hefang_street_sa_01', 'hangzhou_hefang_street', '', '河坊街东入口', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_hefang_street_sa_02', 'hangzhou_hefang_street', '', '吴山广场与城隍阁', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_hefang_street_sa_03', 'hangzhou_hefang_street', '', '鼓楼', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_hefang_street_sa_04', 'hangzhou_hefang_street', '', '望仙阁', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_hefang_street_sa_05', 'hangzhou_hefang_street', '', '胡庆余堂中药博物馆', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_hefang_street_sa_06', 'hangzhou_hefang_street', '', '方回春堂', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_hefang_street_sa_07', 'hangzhou_hefang_street', '', '朱炳仁铜雕艺术博物馆', '<p>Description</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_hefang_street_sa_08', 'hangzhou_hefang_street', '', '江南铜屋', '<p>Description</p>', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_hefang_street_sa_09', 'hangzhou_hefang_street', '', '南宋御街', '<p>Description</p>', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_hefang_street_sa_10', 'hangzhou_hefang_street', '', '大井巷', '<p>Description</p>', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_faxi_temple_sa_01', 'hangzhou_faxi_temple', '', '法喜寺山门', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_faxi_temple_sa_02', 'hangzhou_faxi_temple', '', '法喜寺素斋堂', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_faxi_temple_sa_03', 'hangzhou_faxi_temple', '', '天王殿', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_faxi_temple_sa_04', 'hangzhou_faxi_temple', '', '圆通宝殿', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_faxi_temple_sa_05', 'hangzhou_faxi_temple', '', '大雄宝殿', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_faxi_temple_sa_06', 'hangzhou_faxi_temple', '', '藏经楼', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_faxi_temple_sa_07', 'hangzhou_faxi_temple', '', '地藏殿', '<p>Description</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_faxi_temple_sa_08', 'hangzhou_faxi_temple', '', '五百罗汉堂', '<p>Description</p>', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_faxi_temple_sa_09', 'hangzhou_faxi_temple', '', '白云峰观景台', '<p>Description</p>', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_faxi_temple_sa_10', 'hangzhou_faxi_temple', '', '御碑亭', '<p>Description</p>', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_zhejiang_museum_sa_01', 'hangzhou_zhejiang_museum', '', '浙江省博物馆之江馆区主入口与大堂', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_zhejiang_museum_sa_02', 'hangzhou_zhejiang_museum', '', '之江文化中心整体参观指南', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_zhejiang_museum_sa_03', 'hangzhou_zhejiang_museum', '', '浙江历史文化陈列厅', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_zhejiang_museum_sa_04', 'hangzhou_zhejiang_museum', '', '青瓷文化馆', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_zhejiang_museum_sa_05', 'hangzhou_zhejiang_museum', '', '海洋文化馆', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_zhejiang_museum_sa_06', 'hangzhou_zhejiang_museum', '', '书画馆', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_zhejiang_museum_sa_07', 'hangzhou_zhejiang_museum', '', '雷峰塔文物馆', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_zhejiang_museum_sa_08', 'hangzhou_zhejiang_museum', '', '之江馆区数字体验馆', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_zhejiang_museum_sa_09', 'hangzhou_zhejiang_museum', '', '之江馆区文创商店', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_zhejiang_museum_sa_10', 'hangzhou_zhejiang_museum', '', '之江馆区特展厅', '', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_lingyin_temple_sa_01', 'hangzhou_lingyin_temple', '', '灵隐寺景区入口', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_lingyin_temple_sa_02', 'hangzhou_lingyin_temple', '', '五百罗汉堂', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_lingyin_temple_sa_03', 'hangzhou_lingyin_temple', '', '飞来峰造像', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_lingyin_temple_sa_04', 'hangzhou_lingyin_temple', '', '理公塔与冷泉亭', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_lingyin_temple_sa_05', 'hangzhou_lingyin_temple', '', '天王殿', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_lingyin_temple_sa_06', 'hangzhou_lingyin_temple', '', '大雄宝殿', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_lingyin_temple_sa_07', 'hangzhou_lingyin_temple', '', '药师殿', '<p>Description</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_lingyin_temple_sa_08', 'hangzhou_lingyin_temple', '', '藏经楼', '<p>Description</p>', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_lingyin_temple_sa_09', 'hangzhou_lingyin_temple', '', '华严殿', '<p>Description</p>', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_lingyin_temple_sa_10', 'hangzhou_lingyin_temple', '', '济公殿', '<p>Description</p>', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liangzhu_ancient_city_sa_01', 'hangzhou_liangzhu_ancient_city', '', '良渚古城遗址公园南入口', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liangzhu_ancient_city_sa_02', 'hangzhou_liangzhu_ancient_city', '', '雉山观景台', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liangzhu_ancient_city_sa_03', 'hangzhou_liangzhu_ancient_city', '', '陆城门遗址', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liangzhu_ancient_city_sa_04', 'hangzhou_liangzhu_ancient_city', '', '水城门遗址', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liangzhu_ancient_city_sa_05', 'hangzhou_liangzhu_ancient_city', '', '南城墙遗址', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liangzhu_ancient_city_sa_06', 'hangzhou_liangzhu_ancient_city', '', '钟家港古河道', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liangzhu_ancient_city_sa_07', 'hangzhou_liangzhu_ancient_city', '', '莫角山宫殿遗址', '<p>Description</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liangzhu_ancient_city_sa_08', 'hangzhou_liangzhu_ancient_city', '', '反山王陵', '<p>Description</p>', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liangzhu_ancient_city_sa_09', 'hangzhou_liangzhu_ancient_city', '', '姜家山贵族墓地', '<p>Description</p>', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_liangzhu_ancient_city_sa_10', 'hangzhou_liangzhu_ancient_city', '', '美人地遗址', '<p>Description</p>', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_sa_01', 'hangzhou_west_lake', '', '断桥残雪', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_sa_02', 'hangzhou_west_lake', '', '柳浪闻莺', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_sa_03', 'hangzhou_west_lake', '', '湖滨公园', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_sa_04', 'hangzhou_west_lake', '', '三潭印月', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_sa_05', 'hangzhou_west_lake', '', '白堤', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_sa_06', 'hangzhou_west_lake', '', '平湖秋月', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_sa_07', 'hangzhou_west_lake', '', '孤山与西泠印社', '<p>Description</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_sa_08', 'hangzhou_west_lake', '', '曲院风荷', '<p>Description</p>', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_sa_09', 'hangzhou_west_lake', '', '苏堤春晓', '<p>Description</p>', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_sa_10', 'hangzhou_west_lake', '', '花港观鱼', '<p>Description</p>', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_sa_11', 'hangzhou_west_lake', '', '雷峰塔', '<p>Description</p>', 10, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_sa_12', 'hangzhou_west_lake', '', '南屏晚钟', '<p>Description</p>', 11, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_cultural_plaza_sa_01', 'hangzhou_west_lake_cultural_plaza', '', '西湖文化广场主雕塑', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_cultural_plaza_sa_02', 'hangzhou_west_lake_cultural_plaza', '', '西湖文化广场银杏大道', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_cultural_plaza_sa_03', 'hangzhou_west_lake_cultural_plaza', '', '浙江省科技馆', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_cultural_plaza_sa_04', 'hangzhou_west_lake_cultural_plaza', '', '浙江自然博物院', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_cultural_plaza_sa_05', 'hangzhou_west_lake_cultural_plaza', '', '浙江省博物馆（武林馆区）', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_cultural_plaza_sa_06', 'hangzhou_west_lake_cultural_plaza', '', '西湖文化广场音乐喷泉', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_cultural_plaza_sa_07', 'hangzhou_west_lake_cultural_plaza', '', '运河魂雕塑与亲水平台', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_cultural_plaza_sa_08', 'hangzhou_west_lake_cultural_plaza', '', '西湖文化广场地下商业街', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_cultural_plaza_sa_09', 'hangzhou_west_lake_cultural_plaza', '', '西湖文化广场七夕灯会会场', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_west_lake_cultural_plaza_sa_10', 'hangzhou_west_lake_cultural_plaza', '', '西湖文化广场城市观景台', '', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xixi_wetland_sa_01', 'hangzhou_xixi_wetland', '', '西溪国家湿地公园北门入口', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xixi_wetland_sa_02', 'hangzhou_xixi_wetland', '', '西溪洪园', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xixi_wetland_sa_03', 'hangzhou_xixi_wetland', '', '秋雪庵', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xixi_wetland_sa_04', 'hangzhou_xixi_wetland', '', '深潭口与河渚街', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xixi_wetland_sa_05', 'hangzhou_xixi_wetland', '', '西溪梅墅', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xixi_wetland_sa_06', 'hangzhou_xixi_wetland', '', '莲花滩观鸟区', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xixi_wetland_sa_07', 'hangzhou_xixi_wetland', '', '西溪草堂', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xixi_wetland_sa_08', 'hangzhou_xixi_wetland', '', '西溪龙舟陈列馆', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xixi_wetland_sa_09', 'hangzhou_xixi_wetland', '', '西溪湿地生态科普馆', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_xixi_wetland_sa_10', 'hangzhou_xixi_wetland', '', '西溪湿地摇橹船体验', '', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_leifeng_pagoda_sa_01', 'hangzhou_leifeng_pagoda', '', '雷峰塔景区入口', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_leifeng_pagoda_sa_02', 'hangzhou_leifeng_pagoda', '', '雷峰塔遗址底层', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_leifeng_pagoda_sa_03', 'hangzhou_leifeng_pagoda', '', '新雷峰塔一层', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_leifeng_pagoda_sa_04', 'hangzhou_leifeng_pagoda', '', '新雷峰塔二至四层', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_leifeng_pagoda_sa_05', 'hangzhou_leifeng_pagoda', '', '雷峰塔顶层观景台', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_leifeng_pagoda_sa_06', 'hangzhou_leifeng_pagoda', '', '雷峰塔文化陈列馆', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'hangzhou_leifeng_pagoda_sa_07', 'hangzhou_leifeng_pagoda', '', '夕照亭与放生池', '<p>Description</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jiujie_sa_01', 'chongqing_jiujie', '', '九街标志牌坊', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jiujie_sa_02', 'chongqing_jiujie', '', '九街高屋', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jiujie_sa_03', 'chongqing_jiujie', '', '鲤鱼池42号文创园', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jiujie_sa_04', 'chongqing_jiujie', '', '九街后街', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_shibati_sa_01', 'chongqing_shibati', '', '十八梯大牌坊', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_shibati_sa_02', 'chongqing_shibati', '', '善果巷与山城记忆馆', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_shibati_sa_03', 'chongqing_shibati', '', '月台坝（山地院落）', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_shibati_sa_04', 'chongqing_shibati', '', '大隧道遗址', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_dazu_rock_carvings_sa_01', 'chongqing_dazu_rock_carvings', '', '宝顶山', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_dazu_rock_carvings_sa_02', 'chongqing_dazu_rock_carvings', '', '北山景区', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_dazu_rock_carvings_sa_03', 'chongqing_dazu_rock_carvings', '', '大足石刻博物馆', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_dazu_rock_carvings_sa_04', 'chongqing_dazu_rock_carvings', '', '南山景区', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_dazu_rock_carvings_sa_05', 'chongqing_dazu_rock_carvings', '', '石门山景区', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_dazu_rock_carvings_sa_06', 'chongqing_dazu_rock_carvings', '', '石篆山', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_mountain_trails_sa_01', 'chongqing_mountain_trails', '', '步道入口牌坊', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_mountain_trails_sa_02', 'chongqing_mountain_trails', '', '厚庐', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_mountain_trails_sa_03', 'chongqing_mountain_trails', '', '悬空栈道', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_mountain_trails_sa_04', 'chongqing_mountain_trails', '', '仁爱荒野剧场', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_liziba_monorail_sa_01', 'chongqing_liziba_monorail', '', '轨道李子坝站1号出口', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_liziba_monorail_sa_02', 'chongqing_liziba_monorail', '', '李子坝观景平台', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_liziba_monorail_sa_03', 'chongqing_liziba_monorail', '', '岩之魂浮雕文化墙', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_liziba_monorail_sa_04', 'chongqing_liziba_monorail', '', '文旅服务中心', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_liziba_monorail_sa_05', 'chongqing_liziba_monorail', '', '巴渝旧闻馆', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_liziba_monorail_sa_06', 'chongqing_liziba_monorail', '', '轨道穿楼主体建筑', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_raffles_city_sa_01', 'chongqing_raffles_city', '', '朝天门广场与两江交汇', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_raffles_city_sa_02', 'chongqing_raffles_city', '', '购物中心中庭与山城花园', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_raffles_city_sa_03', 'chongqing_raffles_city', '', '水晶连廊（探索舱·观景台）', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_raffles_city_sa_04', 'chongqing_raffles_city', '', '探索舱·云端乐园', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_wulong_karst_sa_01', 'chongqing_wulong_karst', '', '天龙桥', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_wulong_karst_sa_02', 'chongqing_wulong_karst', '', '仙女山国家公园-木梯子站', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_wulong_karst_sa_03', 'chongqing_wulong_karst', '', '仙女山国家公园-大草原站', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_wulong_karst_sa_04', 'chongqing_wulong_karst', '', '天官赐福', '<p>Description</p>', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_wulong_karst_sa_05', 'chongqing_wulong_karst', '', '青龙桥', '<p>Description</p>', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_wulong_karst_sa_06', 'chongqing_wulong_karst', '', '神鹰天坑', '<p>Description</p>', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_wulong_karst_sa_07', 'chongqing_wulong_karst', '', '黑龙桥', '<p>Description</p>', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_wulong_karst_sa_08', 'chongqing_wulong_karst', '', '龙泉洞', '<p>Description</p>', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_wulong_karst_sa_09', 'chongqing_wulong_karst', '', '龙水峡地缝', '<p>Description</p>', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_wulong_karst_sa_10', 'chongqing_wulong_karst', '', '银河飞瀑', '<p>Description</p>', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_wulong_karst_sa_11', 'chongqing_wulong_karst', '', '蛟龙寒窟', '<p>Description</p>', 10, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_01', 'chongqing_hongya_cave', '', '重庆洪崖洞民俗风貌区', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_02', 'chongqing_hongya_cave', '', '六楼：光影互动艺术空间', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_03', 'chongqing_hongya_cave', '', '五楼：重逢1980·八十年代生活情境街区', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_04', 'chongqing_hongya_cave', '', '四楼：盛宴美食街', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_05', 'chongqing_hongya_cave', '', '三楼：天成巷巴渝风情街', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_06', 'chongqing_hongya_cave', '', '二楼：纸盐河动感酒吧街', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_07', 'chongqing_hongya_cave', '', '一楼：滴翠广场', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_08', 'chongqing_hongya_cave', '', '城市阳台', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_09', 'chongqing_hongya_cave', '', '辛亥丰碑', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_10', 'chongqing_hongya_cave', '', '记忆山城雕塑', '', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_11', 'chongqing_hongya_cave', '', '江隘炮台铜雕', '', 10, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_12', 'chongqing_hongya_cave', '', '十楼：巴文化柱', '', 11, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_13', 'chongqing_hongya_cave', '', '九楼：异域风情街', '', 12, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_14', 'chongqing_hongya_cave', '', '八楼：78区潮玩世界', '', 13, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_hongya_cave_sa_15', 'chongqing_hongya_cave', '', '七楼：78区潮玩世界', '', 14, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_baixiangju_sa_01', 'chongqing_baixiangju', '', '层临江入口（起点）', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_baixiangju_sa_02', 'chongqing_baixiangju', '', '层空中公共连廊', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_baixiangju_sa_03', 'chongqing_baixiangju', '', '长江索道同框观景窗', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_baixiangju_sa_04', 'chongqing_baixiangju', '', '层解放东路出口（终点）', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_ciqikou_old_town_sa_01', 'chongqing_ciqikou_old_town', '', '黄桷坪牌坊', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_ciqikou_old_town_sa_02', 'chongqing_ciqikou_old_town', '', '磁器长歌体验馆', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_ciqikou_old_town_sa_03', 'chongqing_ciqikou_old_town', '', '钟家院', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_ciqikou_old_town_sa_04', 'chongqing_ciqikou_old_town', '', '宝善宫', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_ciqikou_old_town_sa_05', 'chongqing_ciqikou_old_town', '', '鑫记杂货铺', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_ciqikou_old_town_sa_06', 'chongqing_ciqikou_old_town', '', '聚森茂酱园旧址', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_ciqikou_old_town_sa_07', 'chongqing_ciqikou_old_town', '', '磁横街', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_ciqikou_old_town_sa_08', 'chongqing_ciqikou_old_town', '', '宝轮寺', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_ciqikou_old_town_sa_09', 'chongqing_ciqikou_old_town', '', '迎龙门码头', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_ciqikou_old_town_sa_10', 'chongqing_ciqikou_old_town', '', '九石缸河滩', '', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_guanyinqiao_sa_01', 'chongqing_guanyinqiao', '', '观音桥步行街广场', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_guanyinqiao_sa_02', 'chongqing_guanyinqiao', '', '茂业天地“裸眼3D”大屏', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_guanyinqiao_sa_03', 'chongqing_guanyinqiao', '', '观音桥雕塑（城市标志）', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_guanyinqiao_sa_04', 'chongqing_guanyinqiao', '', '北城天街', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_guanyinqiao_sa_05', 'chongqing_guanyinqiao', '', '观音桥九街（不夜九街 - 终点）', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jiefangbei_sa_01', 'chongqing_jiefangbei', '', '解放碑广场', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jiefangbei_sa_02', 'chongqing_jiefangbei', '', '解放碑纪念碑', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jiefangbei_sa_03', 'chongqing_jiefangbei', '', '解放碑步行街雕塑群', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jiefangbei_sa_04', 'chongqing_jiefangbei', '', '邹容路步行街', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jiefangbei_sa_05', 'chongqing_jiefangbei', '', '八一路好吃街', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jiefangbei_sa_06', 'chongqing_jiefangbei', '', '环球金融中心会仙楼观景台', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_zoo_sa_01', 'chongqing_zoo', '', '大门广场（起点）', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_zoo_sa_02', 'chongqing_zoo', '', '熊猫馆', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_zoo_sa_03', 'chongqing_zoo', '', '金鱼馆', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_zoo_sa_04', 'chongqing_zoo', '', '两栖爬行动物馆', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_zoo_sa_05', 'chongqing_zoo', '', '鸟类区', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_01', 'chongqing_jinfo_mountain', '', '大门', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_02', 'chongqing_jinfo_mountain', '', '药池坝', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_03', 'chongqing_jinfo_mountain', '', '古佛洞', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_04', 'chongqing_jinfo_mountain', '', '金佛顶', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_05', 'chongqing_jinfo_mountain', '', '生态石林', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_06', 'chongqing_jinfo_mountain', '', '西门索道下站', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_07', 'chongqing_jinfo_mountain', '', '西门游客中心', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_08', 'chongqing_jinfo_mountain', '', '碧潭幽谷', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_09', 'chongqing_jinfo_mountain', '', '索道下站', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_10', 'chongqing_jinfo_mountain', '', '牵牛坪天街', '', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_11', 'chongqing_jinfo_mountain', '', '箭竹林海', '', 10, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_12', 'chongqing_jinfo_mountain', '', '金龟朝阳', '', 11, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_13', 'chongqing_jinfo_mountain', '', '云端步道', '', 12, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_14', 'chongqing_jinfo_mountain', '', '燕子洞和灵观洞', '', 13, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_jinfo_mountain_sa_15', 'chongqing_jinfo_mountain', '', '杜鹃王子', '', 14, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_yangtze_cableway_sa_01', 'chongqing_yangtze_cableway', '', '北站（渝中区新华路站）', '<p>Description</p>', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_yangtze_cableway_sa_02', 'chongqing_yangtze_cableway', '', '索道轿厢', '<p>Description</p>', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_yangtze_cableway_sa_03', 'chongqing_yangtze_cableway', '', '南站（南岸区龙门浩站）', '<p>Description</p>', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_01', 'chongqing_eling_2nd_factory', '', '大门', '', 0, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_02', 'chongqing_eling_2nd_factory', '', '螺旋楼梯和涂鸦巷', '', 1, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_03', 'chongqing_eling_2nd_factory', '', '巨型拉链雕塑', '', 2, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_04', 'chongqing_eling_2nd_factory', '', '下沉广场', '', 3, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_05', 'chongqing_eling_2nd_factory', '', '重庆书局', '', 4, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_06', 'chongqing_eling_2nd_factory', '', '你好童年怀旧馆', '', 5, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_07', 'chongqing_eling_2nd_factory', '', '二厂记忆博物馆', '', 6, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_08', 'chongqing_eling_2nd_factory', '', '民国中央银行印钞厂旧址（9号楼）', '', 7, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_09', 'chongqing_eling_2nd_factory', '', 'Test Design街巷', '', 8, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_10', 'chongqing_eling_2nd_factory', '', 'Test Joy街巷', '', 9, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_11', 'chongqing_eling_2nd_factory', '', 'Test Spirit街巷', '', 10, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_12', 'chongqing_eling_2nd_factory', '', 'T²国际当代艺术中心', '', 11, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_13', 'chongqing_eling_2nd_factory', '', '爱情天台（CITY-RADIO电台墙）', '', 12, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
...
INSERT INTO sub_areas (
  ...
  'chongqing_eling_2nd_factory_sa_14', 'chongqing_eling_2nd_factory', '', '云上天台', '', 13, TRUE
) ON CONFLICT (id) DO UPDATE SET
  name_en=EXCLUDED.name_en,
  name_zh=EXCLUDED.name_zh,
  body=EXCLUDED.body,
