...
App.fillTableDefaults = function fillTableDefaults(payload, table) {
  ...
  const defaults = {
    ...
    visa_policies_v2: { policy_type: "", node_kind: "computed", universal: false, official_name_zh: "", official_name_en: "", onward_ticket: false, onward_third_country: false, group_required: false, entry_port_limited: false, passport_validity_months: 6, priority: 0, is_active: true },
    visa_policy_grants_v2: { is_active: true },
    visa_cities: { region_type: "mainland", is_entry_port: false, is_exit_port: false, transit_240h: false, is_active: true },
    visa_permit_zones: { is_active: true },
